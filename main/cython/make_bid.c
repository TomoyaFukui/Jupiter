 ...
 */
  ...
  __pyx_t_2 = PyObject_Length(__pyx_t_1); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_2 = PyList_GET_SIZE(__pyx_v_weight_list_list); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 5, __pyx_L1_error)
