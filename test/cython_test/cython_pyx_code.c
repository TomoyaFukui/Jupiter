...
static PyObject *__pyx_pf_11cython_code_cy_algo(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_arr_a, PyArrayObject *__pyx_v_arr_b) {
  ...
  __pyx_pybuffernd_arr_b.rcbuffer = &__pyx_pybuffer_arr_b;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_arr_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_arr_a, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_arr_b.rcbuffer->pybuffer, (PyObject*)__pyx_v_arr_b, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_4 = PyObject_Length(((PyObject *)__pyx_v_arr_a)); if (unlikely(__pyx_t_4 == -1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_5 = PyObject_Length(((PyObject *)__pyx_v_arr_b)); if (unlikely(__pyx_t_5 == -1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_6 = __Pyx_PyInt_From_int(c_algo((&(*__Pyx_BufPtrStrided1d(int *, __pyx_pybuffernd_arr_a.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_arr_a.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided1d(int *, __pyx_pybuffernd_arr_b.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_arr_b.diminfo[0].strides))), __pyx_t_4, __pyx_t_5)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 7, __pyx_L1_error)
