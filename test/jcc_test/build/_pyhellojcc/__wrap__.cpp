  ...
  namespace lang {
    ...
    jclass Integer::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_a9395152fa63d3b0] = env->getMethodID(cls, "<init>", "(I)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_bitCount_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "bitCount", "(I)I");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "compare", "(II)I");
        mids$[mid_compareTo_f87645181f9a1291] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Integer;)I");
        mids$[mid_compareUnsigned_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "compareUnsigned", "(II)I");
        mids$[mid_decode_12066d8742764eab] = env->getStaticMethodID(cls, "decode", "(Ljava/lang/String;)Ljava/lang/Integer;");
        mids$[mid_divideUnsigned_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "divideUnsigned", "(II)I");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_getInteger_12066d8742764eab] = env->getStaticMethodID(cls, "getInteger", "(Ljava/lang/String;)Ljava/lang/Integer;");
        mids$[mid_getInteger_1eeab593d705129b] = env->getStaticMethodID(cls, "getInteger", "(Ljava/lang/String;I)Ljava/lang/Integer;");
        mids$[mid_getInteger_43f55f4841c44178] = env->getStaticMethodID(cls, "getInteger", "(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/Integer;");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "hashCode", "(I)I");
        mids$[mid_highestOneBit_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "highestOneBit", "(I)I");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_lowestOneBit_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "lowestOneBit", "(I)I");
        mids$[mid_max_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "max", "(II)I");
        mids$[mid_min_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "min", "(II)I");
        mids$[mid_numberOfLeadingZeros_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "numberOfLeadingZeros", "(I)I");
        mids$[mid_numberOfTrailingZeros_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "numberOfTrailingZeros", "(I)I");
        mids$[mid_parseInt_9a1fdcf5cfdf78dc] = env->getStaticMethodID(cls, "parseInt", "(Ljava/lang/String;)I");
        mids$[mid_parseInt_e65105c140eb7151] = env->getStaticMethodID(cls, "parseInt", "(Ljava/lang/String;I)I");
        mids$[mid_parseUnsignedInt_9a1fdcf5cfdf78dc] = env->getStaticMethodID(cls, "parseUnsignedInt", "(Ljava/lang/String;)I");
        mids$[mid_parseUnsignedInt_e65105c140eb7151] = env->getStaticMethodID(cls, "parseUnsignedInt", "(Ljava/lang/String;I)I");
        mids$[mid_remainderUnsigned_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "remainderUnsigned", "(II)I");
        mids$[mid_reverse_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "reverse", "(I)I");
        mids$[mid_reverseBytes_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "reverseBytes", "(I)I");
        mids$[mid_rotateLeft_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "rotateLeft", "(II)I");
        mids$[mid_rotateRight_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "rotateRight", "(II)I");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_signum_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "signum", "(I)I");
        mids$[mid_sum_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "sum", "(II)I");
        mids$[mid_toBinaryString_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "toBinaryString", "(I)Ljava/lang/String;");
        mids$[mid_toHexString_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "toHexString", "(I)Ljava/lang/String;");
        mids$[mid_toOctalString_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "toOctalString", "(I)Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "toString", "(I)Ljava/lang/String;");
        mids$[mid_toString_5b238f74b18cd9ba] = env->getStaticMethodID(cls, "toString", "(II)Ljava/lang/String;");
        mids$[mid_toUnsignedLong_dcd2935a5563d052] = env->getStaticMethodID(cls, "toUnsignedLong", "(I)J");
        mids$[mid_toUnsignedString_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "toUnsignedString", "(I)Ljava/lang/String;");
        mids$[mid_toUnsignedString_5b238f74b18cd9ba] = env->getStaticMethodID(cls, "toUnsignedString", "(II)Ljava/lang/String;");
        mids$[mid_valueOf_6e6e43bd124aa371] = env->getStaticMethodID(cls, "valueOf", "(I)Ljava/lang/Integer;");
        mids$[mid_valueOf_12066d8742764eab] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Integer;");
        mids$[mid_valueOf_1eeab593d705129b] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;I)Ljava/lang/Integer;");
    ...
    Integer::Integer(jint a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_a9395152fa63d3b0, a0)) {}

    Integer::Integer(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    jint Integer::bitCount(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_bitCount_4b23a339ec27bbb3], a0);
    }

    jbyte Integer::byteValue() const
    {
      return env->callByteMethod(this$, mids$[mid_byteValue_51018f1683a6b595]);
    }

    jint Integer::compare(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_3d7ede988f6b3a33], a0, a1);
    }

    jint Integer::compareTo(const Integer & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_f87645181f9a1291], a0.this$);
    }

    jint Integer::compareUnsigned(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compareUnsigned_3d7ede988f6b3a33], a0, a1);
    }

    Integer Integer::decode(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_decode_12066d8742764eab], a0.this$));
    }

    jint Integer::divideUnsigned(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_divideUnsigned_3d7ede988f6b3a33], a0, a1);
    }

    jdouble Integer::doubleValue() const
    {
      return env->callDoubleMethod(this$, mids$[mid_doubleValue_746fdfc2336a8dce]);
    }

    jboolean Integer::equals(const ::java::lang::Object & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_equals_04e1a7382c29bc4b], a0.this$);
    }

    jfloat Integer::floatValue() const
    {
      return env->callFloatMethod(this$, mids$[mid_floatValue_4e51965d8682d4e7]);
    }

    Integer Integer::getInteger(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_getInteger_12066d8742764eab], a0.this$));
    }

    Integer Integer::getInteger(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_getInteger_1eeab593d705129b], a0.this$, a1));
    }

    Integer Integer::getInteger(const ::java::lang::String & a0, const Integer & a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_getInteger_43f55f4841c44178], a0.this$, a1.this$));
    }

    jint Integer::hashCode() const
    {
      return env->callIntMethod(this$, mids$[mid_hashCode_60df5a771df5b62d]);
    }

    jint Integer::hashCode(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_4b23a339ec27bbb3], a0);
    }

    jint Integer::highestOneBit(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_highestOneBit_4b23a339ec27bbb3], a0);
    }

    jint Integer::intValue() const
    {
      return env->callIntMethod(this$, mids$[mid_intValue_60df5a771df5b62d]);
    }

    jlong Integer::longValue() const
    {
      return env->callLongMethod(this$, mids$[mid_longValue_0a482dcd1f56375a]);
    }

    jint Integer::lowestOneBit(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_lowestOneBit_4b23a339ec27bbb3], a0);
    }

    jint Integer::max$(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_max_3d7ede988f6b3a33], a0, a1);
    }

    jint Integer::min$(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_min_3d7ede988f6b3a33], a0, a1);
    }

    jint Integer::numberOfLeadingZeros(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_numberOfLeadingZeros_4b23a339ec27bbb3], a0);
    }

    jint Integer::numberOfTrailingZeros(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_numberOfTrailingZeros_4b23a339ec27bbb3], a0);
    }

    jint Integer::parseInt(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_parseInt_9a1fdcf5cfdf78dc], a0.this$);
    }

    jint Integer::parseInt(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_parseInt_e65105c140eb7151], a0.this$, a1);
    }

    jint Integer::parseUnsignedInt(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_parseUnsignedInt_9a1fdcf5cfdf78dc], a0.this$);
    }

    jint Integer::parseUnsignedInt(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_parseUnsignedInt_e65105c140eb7151], a0.this$, a1);
    }

    jint Integer::remainderUnsigned(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_remainderUnsigned_3d7ede988f6b3a33], a0, a1);
    }

    jint Integer::reverse(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_reverse_4b23a339ec27bbb3], a0);
    }

    jint Integer::reverseBytes(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_reverseBytes_4b23a339ec27bbb3], a0);
    }

    jint Integer::rotateLeft(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_rotateLeft_3d7ede988f6b3a33], a0, a1);
    }

    jint Integer::rotateRight(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_rotateRight_3d7ede988f6b3a33], a0, a1);
    }

    jshort Integer::shortValue() const
    {
      return env->callShortMethod(this$, mids$[mid_shortValue_3e271dc4ae1ecc4b]);
    }

    jint Integer::signum(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_signum_4b23a339ec27bbb3], a0);
    }

    jint Integer::sum(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_sum_3d7ede988f6b3a33], a0, a1);
    }

    ::java::lang::String Integer::toBinaryString(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toBinaryString_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String Integer::toHexString(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toHexString_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String Integer::toOctalString(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toOctalString_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String Integer::toString() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_toString_c041e21e63165d2d]));
    }

    ::java::lang::String Integer::toString(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String Integer::toString(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_5b238f74b18cd9ba], a0, a1));
    }

    jlong Integer::toUnsignedLong(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_toUnsignedLong_dcd2935a5563d052], a0);
    }

    ::java::lang::String Integer::toUnsignedString(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toUnsignedString_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String Integer::toUnsignedString(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toUnsignedString_5b238f74b18cd9ba], a0, a1));
    }

    Integer Integer::valueOf(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_valueOf_6e6e43bd124aa371], a0));
    }

    Integer Integer::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_valueOf_12066d8742764eab], a0.this$));
    }

    Integer Integer::valueOf(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Integer(env->callStaticObjectMethod(cls, mids$[mid_valueOf_1eeab593d705129b], a0.this$, a1));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Double::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_4454b3633e331cef] = env->getMethodID(cls, "<init>", "(D)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_6839564546e9f1fc] = env->getStaticMethodID(cls, "compare", "(DD)I");
        mids$[mid_compareTo_92f4a8554f58faae] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Double;)I");
        mids$[mid_doubleToLongBits_1c49831d725774c8] = env->getStaticMethodID(cls, "doubleToLongBits", "(D)J");
        mids$[mid_doubleToRawLongBits_1c49831d725774c8] = env->getStaticMethodID(cls, "doubleToRawLongBits", "(D)J");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_d2deb6bff94c033f] = env->getStaticMethodID(cls, "hashCode", "(D)I");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_isFinite_cd546b9f1e12b4df] = env->getStaticMethodID(cls, "isFinite", "(D)Z");
        mids$[mid_isInfinite_318f7cae9d6a33e6] = env->getMethodID(cls, "isInfinite", "()Z");
        mids$[mid_isInfinite_cd546b9f1e12b4df] = env->getStaticMethodID(cls, "isInfinite", "(D)Z");
        mids$[mid_isNaN_318f7cae9d6a33e6] = env->getMethodID(cls, "isNaN", "()Z");
        mids$[mid_isNaN_cd546b9f1e12b4df] = env->getStaticMethodID(cls, "isNaN", "(D)Z");
        mids$[mid_longBitsToDouble_44c28eee86f9cf15] = env->getStaticMethodID(cls, "longBitsToDouble", "(J)D");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_max_e2d05d76088434f9] = env->getStaticMethodID(cls, "max", "(DD)D");
        mids$[mid_min_e2d05d76088434f9] = env->getStaticMethodID(cls, "min", "(DD)D");
        mids$[mid_parseDouble_28e2edb6c5cc6da0] = env->getStaticMethodID(cls, "parseDouble", "(Ljava/lang/String;)D");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_sum_e2d05d76088434f9] = env->getStaticMethodID(cls, "sum", "(DD)D");
        mids$[mid_toHexString_7d2d6127fa523a6f] = env->getStaticMethodID(cls, "toHexString", "(D)Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_7d2d6127fa523a6f] = env->getStaticMethodID(cls, "toString", "(D)Ljava/lang/String;");
        mids$[mid_valueOf_287134074f47287d] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Double;");
        mids$[mid_valueOf_29fd566b4ddeb2ed] = env->getStaticMethodID(cls, "valueOf", "(D)Ljava/lang/Double;");
    ...
    Double::Double(jdouble a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_4454b3633e331cef, a0)) {}

    Double::Double(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_6839564546e9f1fc], a0, a1);
    }

    jint Double::compareTo(const Double & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_92f4a8554f58faae], a0.this$);
    }

    jlong Double::doubleToLongBits(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_doubleToLongBits_1c49831d725774c8], a0);
    }

    jlong Double::doubleToRawLongBits(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_doubleToRawLongBits_1c49831d725774c8], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_d2deb6bff94c033f], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isFinite_cd546b9f1e12b4df], a0);
    }

    jboolean Double::isInfinite() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isInfinite_318f7cae9d6a33e6]);
    }

    jboolean Double::isInfinite(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isInfinite_cd546b9f1e12b4df], a0);
    }

    jboolean Double::isNaN() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isNaN_318f7cae9d6a33e6]);
    }

    jboolean Double::isNaN(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isNaN_cd546b9f1e12b4df], a0);
    }

    jdouble Double::longBitsToDouble(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticDoubleMethod(cls, mids$[mid_longBitsToDouble_44c28eee86f9cf15], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticDoubleMethod(cls, mids$[mid_max_e2d05d76088434f9], a0, a1);
    }

    jdouble Double::min$(jdouble a0, jdouble a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticDoubleMethod(cls, mids$[mid_min_e2d05d76088434f9], a0, a1);
    }

    jdouble Double::parseDouble(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticDoubleMethod(cls, mids$[mid_parseDouble_28e2edb6c5cc6da0], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticDoubleMethod(cls, mids$[mid_sum_e2d05d76088434f9], a0, a1);
    }

    ::java::lang::String Double::toHexString(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toHexString_7d2d6127fa523a6f], a0));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_7d2d6127fa523a6f], a0));
    }

    Double Double::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Double(env->callStaticObjectMethod(cls, mids$[mid_valueOf_287134074f47287d], a0.this$));
    }

    Double Double::valueOf(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Double(env->callStaticObjectMethod(cls, mids$[mid_valueOf_29fd566b4ddeb2ed], a0));
    }
  }
}
  ...
  namespace util {
    ...
    jclass Iterator::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_hasNext_318f7cae9d6a33e6] = env->getMethodID(cls, "hasNext", "()Z");
        mids$[mid_next_6a490f1da80a3003] = env->getMethodID(cls, "next", "()Ljava/lang/Object;");
        mids$[mid_remove_3b7a1d3d26162b85] = env->getMethodID(cls, "remove", "()V");
    ...
    {
      return env->callBooleanMethod(this$, mids$[mid_hasNext_318f7cae9d6a33e6]);
    }

    ::java::lang::Object Iterator::next() const
    {
      return ::java::lang::Object(env->callObjectMethod(this$, mids$[mid_next_6a490f1da80a3003]));
    }

    void Iterator::remove() const
    {
      env->callVoidMethod(this$, mids$[mid_remove_3b7a1d3d26162b85]);
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Object::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_3b7a1d3d26162b85] = env->getMethodID(cls, "<init>", "()V");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_getClass_0922d10264375499] = env->getMethodID(cls, "getClass", "()Ljava/lang/Class;");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_notify_3b7a1d3d26162b85] = env->getMethodID(cls, "notify", "()V");
        mids$[mid_notifyAll_3b7a1d3d26162b85] = env->getMethodID(cls, "notifyAll", "()V");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_wait_3b7a1d3d26162b85] = env->getMethodID(cls, "wait", "()V");
        mids$[mid_wait_625495ddbdca45a4] = env->getMethodID(cls, "wait", "(J)V");
        mids$[mid_wait_8427b8c20e0848b6] = env->getMethodID(cls, "wait", "(JI)V");
        mids$[mid_finalize_3b7a1d3d26162b85] = env->getMethodID(cls, "finalize", "()V");
        mids$[mid_clone_6a490f1da80a3003] = env->getMethodID(cls, "clone", "()Ljava/lang/Object;");
    ...
    Object::Object() : ::JObject(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}
    ...
    {
      return ::java::lang::Class(env->callObjectMethod(this$, mids$[mid_getClass_0922d10264375499]));
    }
    ...
    {
      env->callVoidMethod(this$, mids$[mid_notify_3b7a1d3d26162b85]);
    }

    void Object::notifyAll() const
    {
      env->callVoidMethod(this$, mids$[mid_notifyAll_3b7a1d3d26162b85]);
    }
    ...
    {
      env->callVoidMethod(this$, mids$[mid_wait_3b7a1d3d26162b85]);
    }

    void Object::wait(jlong a0) const
    {
      env->callVoidMethod(this$, mids$[mid_wait_625495ddbdca45a4], a0);
    }

    void Object::wait(jlong a0, jint a1) const
    {
      env->callVoidMethod(this$, mids$[mid_wait_8427b8c20e0848b6], a0, a1);
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Short::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_1d5e76b0d1ff996b] = env->getMethodID(cls, "<init>", "(S)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_fd1c99d3b8e6358d] = env->getStaticMethodID(cls, "compare", "(SS)I");
        mids$[mid_compareTo_026e0f72b4764711] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Short;)I");
        mids$[mid_decode_e18c8797d0875fab] = env->getStaticMethodID(cls, "decode", "(Ljava/lang/String;)Ljava/lang/Short;");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_db8176b0b41c5242] = env->getStaticMethodID(cls, "hashCode", "(S)I");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_parseShort_08e1e4518fd65a2c] = env->getStaticMethodID(cls, "parseShort", "(Ljava/lang/String;)S");
        mids$[mid_parseShort_277d20e112906cfb] = env->getStaticMethodID(cls, "parseShort", "(Ljava/lang/String;I)S");
        mids$[mid_reverseBytes_66c589924122c889] = env->getStaticMethodID(cls, "reverseBytes", "(S)S");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_16d144baec28fe9d] = env->getStaticMethodID(cls, "toString", "(S)Ljava/lang/String;");
        mids$[mid_toUnsignedInt_db8176b0b41c5242] = env->getStaticMethodID(cls, "toUnsignedInt", "(S)I");
        mids$[mid_toUnsignedLong_979b1c7e23ecda06] = env->getStaticMethodID(cls, "toUnsignedLong", "(S)J");
        mids$[mid_valueOf_82e3959169cb2447] = env->getStaticMethodID(cls, "valueOf", "(S)Ljava/lang/Short;");
        mids$[mid_valueOf_e18c8797d0875fab] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Short;");
        mids$[mid_valueOf_4dba6c05c2e06f44] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;I)Ljava/lang/Short;");
    ...
    Short::Short(jshort a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_1d5e76b0d1ff996b, a0)) {}

    Short::Short(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_fd1c99d3b8e6358d], a0, a1);
    }

    jint Short::compareTo(const Short & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_026e0f72b4764711], a0.this$);
    }

    Short Short::decode(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Short(env->callStaticObjectMethod(cls, mids$[mid_decode_e18c8797d0875fab], a0.this$));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_db8176b0b41c5242], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticShortMethod(cls, mids$[mid_parseShort_08e1e4518fd65a2c], a0.this$);
    }

    jshort Short::parseShort(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticShortMethod(cls, mids$[mid_parseShort_277d20e112906cfb], a0.this$, a1);
    }

    jshort Short::reverseBytes(jshort a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticShortMethod(cls, mids$[mid_reverseBytes_66c589924122c889], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_16d144baec28fe9d], a0));
    }

    jint Short::toUnsignedInt(jshort a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toUnsignedInt_db8176b0b41c5242], a0);
    }

    jlong Short::toUnsignedLong(jshort a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_toUnsignedLong_979b1c7e23ecda06], a0);
    }

    Short Short::valueOf(jshort a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Short(env->callStaticObjectMethod(cls, mids$[mid_valueOf_82e3959169cb2447], a0));
    }

    Short Short::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Short(env->callStaticObjectMethod(cls, mids$[mid_valueOf_e18c8797d0875fab], a0.this$));
    }

    Short Short::valueOf(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Short(env->callStaticObjectMethod(cls, mids$[mid_valueOf_4dba6c05c2e06f44], a0.this$, a1));
    }
  }
}
...
namespace java {
  namespace lang {
    ...
    Number::Number() : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}
  ...
  namespace io {
    ...
    jclass StringWriter::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_3b7a1d3d26162b85] = env->getMethodID(cls, "<init>", "()V");
        mids$[mid_init$_a9395152fa63d3b0] = env->getMethodID(cls, "<init>", "(I)V");
        mids$[mid_append_a6909a6e91f34e5c] = env->getMethodID(cls, "append", "(C)Ljava/io/StringWriter;");
        mids$[mid_append_dc0be884298a28b7] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/io/StringWriter;");
        mids$[mid_append_c9c6d796987b0032] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/io/StringWriter;");
        mids$[mid_close_3b7a1d3d26162b85] = env->getMethodID(cls, "close", "()V");
        mids$[mid_flush_3b7a1d3d26162b85] = env->getMethodID(cls, "flush", "()V");
        mids$[mid_getBuffer_c9864812d0ad9e24] = env->getMethodID(cls, "getBuffer", "()Ljava/lang/StringBuffer;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_write_38d57a80b9fe8948] = env->getMethodID(cls, "write", "(Ljava/lang/String;)V");
        mids$[mid_write_a9395152fa63d3b0] = env->getMethodID(cls, "write", "(I)V");
        mids$[mid_write_328bb6dd18104856] = env->getMethodID(cls, "write", "(Ljava/lang/String;II)V");
        mids$[mid_write_7b7b455231dae263] = env->getMethodID(cls, "write", "([CII)V");
    ...
    StringWriter::StringWriter() : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    StringWriter::StringWriter(jint a0) : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_a9395152fa63d3b0, a0)) {}

    StringWriter StringWriter::append(jchar a0) const
    {
      return StringWriter(env->callObjectMethod(this$, mids$[mid_append_a6909a6e91f34e5c], a0));
    }

    StringWriter StringWriter::append(const ::java::lang::CharSequence & a0) const
    {
      return StringWriter(env->callObjectMethod(this$, mids$[mid_append_dc0be884298a28b7], a0.this$));
    }

    StringWriter StringWriter::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return StringWriter(env->callObjectMethod(this$, mids$[mid_append_c9c6d796987b0032], a0.this$, a1, a2));
    }

    void StringWriter::close() const
    {
      env->callVoidMethod(this$, mids$[mid_close_3b7a1d3d26162b85]);
    }

    void StringWriter::flush() const
    {
      env->callVoidMethod(this$, mids$[mid_flush_3b7a1d3d26162b85]);
    }

    ::java::lang::StringBuffer StringWriter::getBuffer() const
    {
      return ::java::lang::StringBuffer(env->callObjectMethod(this$, mids$[mid_getBuffer_c9864812d0ad9e24]));
    }
    ...
    {
      env->callVoidMethod(this$, mids$[mid_write_38d57a80b9fe8948], a0.this$);
    }

    void StringWriter::write(jint a0) const
    {
      env->callVoidMethod(this$, mids$[mid_write_a9395152fa63d3b0], a0);
    }

    void StringWriter::write(const ::java::lang::String & a0, jint a1, jint a2) const
    {
      env->callVoidMethod(this$, mids$[mid_write_328bb6dd18104856], a0.this$, a1, a2);
    }

    void StringWriter::write(const JArray< jchar > & a0, jint a1, jint a2) const
    {
      env->callVoidMethod(this$, mids$[mid_write_7b7b455231dae263], a0.this$, a1, a2);
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Boolean::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_4e7a2bdefbe801b3] = env->getMethodID(cls, "<init>", "(Z)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_booleanValue_318f7cae9d6a33e6] = env->getMethodID(cls, "booleanValue", "()Z");
        mids$[mid_compare_dafedceba9ed4732] = env->getStaticMethodID(cls, "compare", "(ZZ)I");
        mids$[mid_compareTo_2782815c9d802298] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Boolean;)I");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_getBoolean_1dfa664233a47103] = env->getStaticMethodID(cls, "getBoolean", "(Ljava/lang/String;)Z");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_25b517ea402753ea] = env->getStaticMethodID(cls, "hashCode", "(Z)I");
        mids$[mid_logicalAnd_38d082b5ba57e3da] = env->getStaticMethodID(cls, "logicalAnd", "(ZZ)Z");
        mids$[mid_logicalOr_38d082b5ba57e3da] = env->getStaticMethodID(cls, "logicalOr", "(ZZ)Z");
        mids$[mid_logicalXor_38d082b5ba57e3da] = env->getStaticMethodID(cls, "logicalXor", "(ZZ)Z");
        mids$[mid_parseBoolean_1dfa664233a47103] = env->getStaticMethodID(cls, "parseBoolean", "(Ljava/lang/String;)Z");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_ea6d2a082bd69826] = env->getStaticMethodID(cls, "toString", "(Z)Ljava/lang/String;");
        mids$[mid_valueOf_b199b80b8fd38ec9] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Boolean;");
        mids$[mid_valueOf_3abd42eab99f6729] = env->getStaticMethodID(cls, "valueOf", "(Z)Ljava/lang/Boolean;");
    ...
    Boolean::Boolean(jboolean a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_4e7a2bdefbe801b3, a0)) {}

    Boolean::Boolean(const ::java::lang::String & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    jboolean Boolean::booleanValue() const
    {
      return env->callBooleanMethod(this$, mids$[mid_booleanValue_318f7cae9d6a33e6]);
    }

    jint Boolean::compare(jboolean a0, jboolean a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_dafedceba9ed4732], a0, a1);
    }

    jint Boolean::compareTo(const Boolean & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_2782815c9d802298], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_getBoolean_1dfa664233a47103], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_25b517ea402753ea], a0);
    }

    jboolean Boolean::logicalAnd(jboolean a0, jboolean a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_logicalAnd_38d082b5ba57e3da], a0, a1);
    }

    jboolean Boolean::logicalOr(jboolean a0, jboolean a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_logicalOr_38d082b5ba57e3da], a0, a1);
    }

    jboolean Boolean::logicalXor(jboolean a0, jboolean a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_logicalXor_38d082b5ba57e3da], a0, a1);
    }

    jboolean Boolean::parseBoolean(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_parseBoolean_1dfa664233a47103], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_ea6d2a082bd69826], a0));
    }

    Boolean Boolean::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Boolean(env->callStaticObjectMethod(cls, mids$[mid_valueOf_b199b80b8fd38ec9], a0.this$));
    }

    Boolean Boolean::valueOf(jboolean a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Boolean(env->callStaticObjectMethod(cls, mids$[mid_valueOf_3abd42eab99f6729], a0));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Class::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_asSubclass_4774fc9aadd29538] = env->getMethodID(cls, "asSubclass", "(Ljava/lang/Class;)Ljava/lang/Class;");
        mids$[mid_cast_5cfb9aa5c138c100] = env->getMethodID(cls, "cast", "(Ljava/lang/Object;)Ljava/lang/Object;");
        mids$[mid_desiredAssertionStatus_318f7cae9d6a33e6] = env->getMethodID(cls, "desiredAssertionStatus", "()Z");
        mids$[mid_forName_3db5ad13abace10f] = env->getStaticMethodID(cls, "forName", "(Ljava/lang/String;)Ljava/lang/Class;");
        mids$[mid_forName_901884e88fd031f0] = env->getStaticMethodID(cls, "forName", "(Ljava/lang/String;ZLjava/lang/ClassLoader;)Ljava/lang/Class;");
        mids$[mid_getCanonicalName_c041e21e63165d2d] = env->getMethodID(cls, "getCanonicalName", "()Ljava/lang/String;");
        mids$[mid_getClassLoader_c3b4e13d45aa948d] = env->getMethodID(cls, "getClassLoader", "()Ljava/lang/ClassLoader;");
        mids$[mid_getClasses_8b92e6f57abcba7e] = env->getMethodID(cls, "getClasses", "()[Ljava/lang/Class;");
        mids$[mid_getComponentType_0922d10264375499] = env->getMethodID(cls, "getComponentType", "()Ljava/lang/Class;");
        mids$[mid_getDeclaredClasses_8b92e6f57abcba7e] = env->getMethodID(cls, "getDeclaredClasses", "()[Ljava/lang/Class;");
        mids$[mid_getDeclaringClass_0922d10264375499] = env->getMethodID(cls, "getDeclaringClass", "()Ljava/lang/Class;");
        mids$[mid_getEnclosingClass_0922d10264375499] = env->getMethodID(cls, "getEnclosingClass", "()Ljava/lang/Class;");
        mids$[mid_getEnumConstants_2fc1d90a855043f7] = env->getMethodID(cls, "getEnumConstants", "()[Ljava/lang/Object;");
        mids$[mid_getInterfaces_8b92e6f57abcba7e] = env->getMethodID(cls, "getInterfaces", "()[Ljava/lang/Class;");
        mids$[mid_getModifiers_60df5a771df5b62d] = env->getMethodID(cls, "getModifiers", "()I");
        mids$[mid_getName_c041e21e63165d2d] = env->getMethodID(cls, "getName", "()Ljava/lang/String;");
        mids$[mid_getPackage_39e15168226e8bf5] = env->getMethodID(cls, "getPackage", "()Ljava/lang/Package;");
        mids$[mid_getSigners_2fc1d90a855043f7] = env->getMethodID(cls, "getSigners", "()[Ljava/lang/Object;");
        mids$[mid_getSimpleName_c041e21e63165d2d] = env->getMethodID(cls, "getSimpleName", "()Ljava/lang/String;");
        mids$[mid_getSuperclass_0922d10264375499] = env->getMethodID(cls, "getSuperclass", "()Ljava/lang/Class;");
        mids$[mid_getTypeName_c041e21e63165d2d] = env->getMethodID(cls, "getTypeName", "()Ljava/lang/String;");
        mids$[mid_isAnnotation_318f7cae9d6a33e6] = env->getMethodID(cls, "isAnnotation", "()Z");
        mids$[mid_isAnonymousClass_318f7cae9d6a33e6] = env->getMethodID(cls, "isAnonymousClass", "()Z");
        mids$[mid_isArray_318f7cae9d6a33e6] = env->getMethodID(cls, "isArray", "()Z");
        mids$[mid_isAssignableFrom_996c25acd1f494c9] = env->getMethodID(cls, "isAssignableFrom", "(Ljava/lang/Class;)Z");
        mids$[mid_isEnum_318f7cae9d6a33e6] = env->getMethodID(cls, "isEnum", "()Z");
        mids$[mid_isInstance_04e1a7382c29bc4b] = env->getMethodID(cls, "isInstance", "(Ljava/lang/Object;)Z");
        mids$[mid_isInterface_318f7cae9d6a33e6] = env->getMethodID(cls, "isInterface", "()Z");
        mids$[mid_isLocalClass_318f7cae9d6a33e6] = env->getMethodID(cls, "isLocalClass", "()Z");
        mids$[mid_isMemberClass_318f7cae9d6a33e6] = env->getMethodID(cls, "isMemberClass", "()Z");
        mids$[mid_isPrimitive_318f7cae9d6a33e6] = env->getMethodID(cls, "isPrimitive", "()Z");
        mids$[mid_isSynthetic_318f7cae9d6a33e6] = env->getMethodID(cls, "isSynthetic", "()Z");
        mids$[mid_newInstance_6a490f1da80a3003] = env->getMethodID(cls, "newInstance", "()Ljava/lang/Object;");
        mids$[mid_toGenericString_c041e21e63165d2d] = env->getMethodID(cls, "toGenericString", "()Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
    ...
    {
      return Class(env->callObjectMethod(this$, mids$[mid_asSubclass_4774fc9aadd29538], a0.this$));
    }

    ::java::lang::Object Class::cast(const ::java::lang::Object & a0) const
    {
      return ::java::lang::Object(env->callObjectMethod(this$, mids$[mid_cast_5cfb9aa5c138c100], a0.this$));
    }

    jboolean Class::desiredAssertionStatus() const
    {
      return env->callBooleanMethod(this$, mids$[mid_desiredAssertionStatus_318f7cae9d6a33e6]);
    }

    Class Class::forName(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Class(env->callStaticObjectMethod(cls, mids$[mid_forName_3db5ad13abace10f], a0.this$));
    }

    Class Class::forName(const ::java::lang::String & a0, jboolean a1, const ::java::lang::ClassLoader & a2)
    {
      jclass cls = env->getClass(initializeClass);
      return Class(env->callStaticObjectMethod(cls, mids$[mid_forName_901884e88fd031f0], a0.this$, a1, a2.this$));
    }

    ::java::lang::String Class::getCanonicalName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getCanonicalName_c041e21e63165d2d]));
    }

    ::java::lang::ClassLoader Class::getClassLoader() const
    {
      return ::java::lang::ClassLoader(env->callObjectMethod(this$, mids$[mid_getClassLoader_c3b4e13d45aa948d]));
    }

    JArray< Class > Class::getClasses() const
    {
      return JArray< Class >(env->callObjectMethod(this$, mids$[mid_getClasses_8b92e6f57abcba7e]));
    }

    Class Class::getComponentType() const
    {
      return Class(env->callObjectMethod(this$, mids$[mid_getComponentType_0922d10264375499]));
    }

    JArray< Class > Class::getDeclaredClasses() const
    {
      return JArray< Class >(env->callObjectMethod(this$, mids$[mid_getDeclaredClasses_8b92e6f57abcba7e]));
    }

    Class Class::getDeclaringClass() const
    {
      return Class(env->callObjectMethod(this$, mids$[mid_getDeclaringClass_0922d10264375499]));
    }

    Class Class::getEnclosingClass() const
    {
      return Class(env->callObjectMethod(this$, mids$[mid_getEnclosingClass_0922d10264375499]));
    }

    JArray< ::java::lang::Object > Class::getEnumConstants() const
    {
      return JArray< ::java::lang::Object >(env->callObjectMethod(this$, mids$[mid_getEnumConstants_2fc1d90a855043f7]));
    }

    JArray< Class > Class::getInterfaces() const
    {
      return JArray< Class >(env->callObjectMethod(this$, mids$[mid_getInterfaces_8b92e6f57abcba7e]));
    }

    jint Class::getModifiers() const
    {
      return env->callIntMethod(this$, mids$[mid_getModifiers_60df5a771df5b62d]);
    }

    ::java::lang::String Class::getName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getName_c041e21e63165d2d]));
    }

    ::java::lang::Package Class::getPackage() const
    {
      return ::java::lang::Package(env->callObjectMethod(this$, mids$[mid_getPackage_39e15168226e8bf5]));
    }

    JArray< ::java::lang::Object > Class::getSigners() const
    {
      return JArray< ::java::lang::Object >(env->callObjectMethod(this$, mids$[mid_getSigners_2fc1d90a855043f7]));
    }

    ::java::lang::String Class::getSimpleName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getSimpleName_c041e21e63165d2d]));
    }

    Class Class::getSuperclass() const
    {
      return Class(env->callObjectMethod(this$, mids$[mid_getSuperclass_0922d10264375499]));
    }

    ::java::lang::String Class::getTypeName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getTypeName_c041e21e63165d2d]));
    }

    jboolean Class::isAnnotation() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isAnnotation_318f7cae9d6a33e6]);
    }

    jboolean Class::isAnonymousClass() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isAnonymousClass_318f7cae9d6a33e6]);
    }

    jboolean Class::isArray() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isArray_318f7cae9d6a33e6]);
    }

    jboolean Class::isAssignableFrom(const Class & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_isAssignableFrom_996c25acd1f494c9], a0.this$);
    }

    jboolean Class::isEnum() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isEnum_318f7cae9d6a33e6]);
    }

    jboolean Class::isInstance(const ::java::lang::Object & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_isInstance_04e1a7382c29bc4b], a0.this$);
    }

    jboolean Class::isInterface() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isInterface_318f7cae9d6a33e6]);
    }

    jboolean Class::isLocalClass() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isLocalClass_318f7cae9d6a33e6]);
    }

    jboolean Class::isMemberClass() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isMemberClass_318f7cae9d6a33e6]);
    }

    jboolean Class::isPrimitive() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isPrimitive_318f7cae9d6a33e6]);
    }

    jboolean Class::isSynthetic() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isSynthetic_318f7cae9d6a33e6]);
    }

    ::java::lang::Object Class::newInstance() const
    {
      return ::java::lang::Object(env->callObjectMethod(this$, mids$[mid_newInstance_6a490f1da80a3003]));
    }

    ::java::lang::String Class::toGenericString() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_toGenericString_c041e21e63165d2d]));
    }
  ...
  namespace lang {
    ...
    jclass RuntimeException::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_3b7a1d3d26162b85] = env->getMethodID(cls, "<init>", "()V");
        mids$[mid_init$_359aa6a1d41f0219] = env->getMethodID(cls, "<init>", "(Ljava/lang/Throwable;)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_5df017320dfbf543] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V");
    ...
    RuntimeException::RuntimeException() : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    RuntimeException::RuntimeException(const ::java::lang::Throwable & a0) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_359aa6a1d41f0219, a0.this$)) {}

    RuntimeException::RuntimeException(const ::java::lang::String & a0) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    RuntimeException::RuntimeException(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}
  }
}
  ...
  namespace io {
    ...
    jclass Writer::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_append_49eef9361d8e81fe] = env->getMethodID(cls, "append", "(C)Ljava/io/Writer;");
        mids$[mid_append_2053018ad2e0ce58] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/io/Writer;");
        mids$[mid_append_911f2ada89edf868] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/io/Writer;");
        mids$[mid_close_3b7a1d3d26162b85] = env->getMethodID(cls, "close", "()V");
        mids$[mid_flush_3b7a1d3d26162b85] = env->getMethodID(cls, "flush", "()V");
        mids$[mid_write_ee30b01cc5d9d615] = env->getMethodID(cls, "write", "([C)V");
        mids$[mid_write_a9395152fa63d3b0] = env->getMethodID(cls, "write", "(I)V");
        mids$[mid_write_38d57a80b9fe8948] = env->getMethodID(cls, "write", "(Ljava/lang/String;)V");
        mids$[mid_write_7b7b455231dae263] = env->getMethodID(cls, "write", "([CII)V");
        mids$[mid_write_328bb6dd18104856] = env->getMethodID(cls, "write", "(Ljava/lang/String;II)V");
    ...
    {
      return Writer(env->callObjectMethod(this$, mids$[mid_append_49eef9361d8e81fe], a0));
    }

    Writer Writer::append(const ::java::lang::CharSequence & a0) const
    {
      return Writer(env->callObjectMethod(this$, mids$[mid_append_2053018ad2e0ce58], a0.this$));
    }

    Writer Writer::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return Writer(env->callObjectMethod(this$, mids$[mid_append_911f2ada89edf868], a0.this$, a1, a2));
    }
    ...
    {
      env->callVoidMethod(this$, mids$[mid_write_ee30b01cc5d9d615], a0.this$);
    }
  ...
  namespace io {
    ...
    jclass PrintWriter::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_6c1ced5c118affbd] = env->getMethodID(cls, "<init>", "(Ljava/io/Writer;)V");
        mids$[mid_init$_f6990a6542b56458] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;Ljava/lang/String;)V");
        mids$[mid_init$_0be462401b6d11a7] = env->getMethodID(cls, "<init>", "(Ljava/io/Writer;Z)V");
        mids$[mid_append_14679c9085946363] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/io/PrintWriter;");
        mids$[mid_append_b333bb0e2ebd6eeb] = env->getMethodID(cls, "append", "(C)Ljava/io/PrintWriter;");
        mids$[mid_append_068eb4d597879c27] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/io/PrintWriter;");
        mids$[mid_checkError_318f7cae9d6a33e6] = env->getMethodID(cls, "checkError", "()Z");
        mids$[mid_close_3b7a1d3d26162b85] = env->getMethodID(cls, "close", "()V");
        mids$[mid_flush_3b7a1d3d26162b85] = env->getMethodID(cls, "flush", "()V");
        mids$[mid_format_7ad82831eb68e788] = env->getMethodID(cls, "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;");
        mids$[mid_print_00f6aa63d2ba4dac] = env->getMethodID(cls, "print", "(F)V");
        mids$[mid_print_625495ddbdca45a4] = env->getMethodID(cls, "print", "(J)V");
        mids$[mid_print_a9395152fa63d3b0] = env->getMethodID(cls, "print", "(I)V");
        mids$[mid_print_1e3a1ae808486483] = env->getMethodID(cls, "print", "(C)V");
        mids$[mid_print_4e7a2bdefbe801b3] = env->getMethodID(cls, "print", "(Z)V");
        mids$[mid_print_eb5fd921f75df46a] = env->getMethodID(cls, "print", "(Ljava/lang/Object;)V");
        mids$[mid_print_38d57a80b9fe8948] = env->getMethodID(cls, "print", "(Ljava/lang/String;)V");
        mids$[mid_print_ee30b01cc5d9d615] = env->getMethodID(cls, "print", "([C)V");
        mids$[mid_print_4454b3633e331cef] = env->getMethodID(cls, "print", "(D)V");
        mids$[mid_printf_7ad82831eb68e788] = env->getMethodID(cls, "printf", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;");
        mids$[mid_println_3b7a1d3d26162b85] = env->getMethodID(cls, "println", "()V");
        mids$[mid_println_4454b3633e331cef] = env->getMethodID(cls, "println", "(D)V");
        mids$[mid_println_ee30b01cc5d9d615] = env->getMethodID(cls, "println", "([C)V");
        mids$[mid_println_00f6aa63d2ba4dac] = env->getMethodID(cls, "println", "(F)V");
        mids$[mid_println_38d57a80b9fe8948] = env->getMethodID(cls, "println", "(Ljava/lang/String;)V");
        mids$[mid_println_eb5fd921f75df46a] = env->getMethodID(cls, "println", "(Ljava/lang/Object;)V");
        mids$[mid_println_a9395152fa63d3b0] = env->getMethodID(cls, "println", "(I)V");
        mids$[mid_println_1e3a1ae808486483] = env->getMethodID(cls, "println", "(C)V");
        mids$[mid_println_4e7a2bdefbe801b3] = env->getMethodID(cls, "println", "(Z)V");
        mids$[mid_println_625495ddbdca45a4] = env->getMethodID(cls, "println", "(J)V");
        mids$[mid_write_ee30b01cc5d9d615] = env->getMethodID(cls, "write", "([C)V");
        mids$[mid_write_a9395152fa63d3b0] = env->getMethodID(cls, "write", "(I)V");
        mids$[mid_write_38d57a80b9fe8948] = env->getMethodID(cls, "write", "(Ljava/lang/String;)V");
        mids$[mid_write_7b7b455231dae263] = env->getMethodID(cls, "write", "([CII)V");
        mids$[mid_write_328bb6dd18104856] = env->getMethodID(cls, "write", "(Ljava/lang/String;II)V");
        mids$[mid_setError_3b7a1d3d26162b85] = env->getMethodID(cls, "setError", "()V");
        mids$[mid_clearError_3b7a1d3d26162b85] = env->getMethodID(cls, "clearError", "()V");
    ...
    PrintWriter::PrintWriter(const ::java::lang::String & a0) : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    PrintWriter::PrintWriter(const ::java::io::Writer & a0) : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_6c1ced5c118affbd, a0.this$)) {}

    PrintWriter::PrintWriter(const ::java::lang::String & a0, const ::java::lang::String & a1) : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_f6990a6542b56458, a0.this$, a1.this$)) {}

    PrintWriter::PrintWriter(const ::java::io::Writer & a0, jboolean a1) : ::java::io::Writer(env->newObject(initializeClass, &mids$, mid_init$_0be462401b6d11a7, a0.this$, a1)) {}

    PrintWriter PrintWriter::append(const ::java::lang::CharSequence & a0) const
    {
      return PrintWriter(env->callObjectMethod(this$, mids$[mid_append_14679c9085946363], a0.this$));
    }

    PrintWriter PrintWriter::append(jchar a0) const
    {
      return PrintWriter(env->callObjectMethod(this$, mids$[mid_append_b333bb0e2ebd6eeb], a0));
    }

    PrintWriter PrintWriter::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return PrintWriter(env->callObjectMethod(this$, mids$[mid_append_068eb4d597879c27], a0.this$, a1, a2));
    }

    jboolean PrintWriter::checkError() const
    {
      return env->callBooleanMethod(this$, mids$[mid_checkError_318f7cae9d6a33e6]);
    }
    ...
    {
      return PrintWriter(env->callObjectMethod(this$, mids$[mid_format_7ad82831eb68e788], a0.this$, a1.this$));
    }

    void PrintWriter::print(jfloat a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_00f6aa63d2ba4dac], a0);
    }

    void PrintWriter::print(jlong a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_625495ddbdca45a4], a0);
    }

    void PrintWriter::print(jint a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_a9395152fa63d3b0], a0);
    }

    void PrintWriter::print(jchar a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_1e3a1ae808486483], a0);
    }

    void PrintWriter::print(jboolean a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_4e7a2bdefbe801b3], a0);
    }

    void PrintWriter::print(const ::java::lang::Object & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_eb5fd921f75df46a], a0.this$);
    }

    void PrintWriter::print(const ::java::lang::String & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_38d57a80b9fe8948], a0.this$);
    }

    void PrintWriter::print(const JArray< jchar > & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_ee30b01cc5d9d615], a0.this$);
    }

    void PrintWriter::print(jdouble a0) const
    {
      env->callVoidMethod(this$, mids$[mid_print_4454b3633e331cef], a0);
    }

    PrintWriter PrintWriter::printf(const ::java::lang::String & a0, const JArray< ::java::lang::Object > & a1) const
    {
      return PrintWriter(env->callObjectMethod(this$, mids$[mid_printf_7ad82831eb68e788], a0.this$, a1.this$));
    }

    void PrintWriter::println() const
    {
      env->callVoidMethod(this$, mids$[mid_println_3b7a1d3d26162b85]);
    }

    void PrintWriter::println(jdouble a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_4454b3633e331cef], a0);
    }

    void PrintWriter::println(const JArray< jchar > & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_ee30b01cc5d9d615], a0.this$);
    }

    void PrintWriter::println(jfloat a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_00f6aa63d2ba4dac], a0);
    }

    void PrintWriter::println(const ::java::lang::String & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_38d57a80b9fe8948], a0.this$);
    }

    void PrintWriter::println(const ::java::lang::Object & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_eb5fd921f75df46a], a0.this$);
    }

    void PrintWriter::println(jint a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_a9395152fa63d3b0], a0);
    }

    void PrintWriter::println(jchar a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_1e3a1ae808486483], a0);
    }

    void PrintWriter::println(jboolean a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_4e7a2bdefbe801b3], a0);
    }

    void PrintWriter::println(jlong a0) const
    {
      env->callVoidMethod(this$, mids$[mid_println_625495ddbdca45a4], a0);
    }
...
namespace java {
  namespace lang {
    ...
    Exception::Exception() : ::java::lang::Throwable(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    Exception::Exception(const ::java::lang::Throwable & a0) : ::java::lang::Throwable(env->newObject(initializeClass, &mids$, mid_init$_359aa6a1d41f0219, a0.this$)) {}

    Exception::Exception(const ::java::lang::String & a0) : ::java::lang::Throwable(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    Exception::Exception(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::Throwable(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}
  }
}
  ...
  namespace lang {
    ...
    jclass Character::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_1e3a1ae808486483] = env->getMethodID(cls, "<init>", "(C)V");
        mids$[mid_charCount_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "charCount", "(I)I");
        mids$[mid_charValue_27667b9767feeda0] = env->getMethodID(cls, "charValue", "()C");
        mids$[mid_codePointAt_98218a2785b3f776] = env->getStaticMethodID(cls, "codePointAt", "([CI)I");
        mids$[mid_codePointAt_4c67fb52be240c28] = env->getStaticMethodID(cls, "codePointAt", "(Ljava/lang/CharSequence;I)I");
        mids$[mid_codePointAt_b92cf8f753e2d54d] = env->getStaticMethodID(cls, "codePointAt", "([CII)I");
        mids$[mid_codePointBefore_98218a2785b3f776] = env->getStaticMethodID(cls, "codePointBefore", "([CI)I");
        mids$[mid_codePointBefore_4c67fb52be240c28] = env->getStaticMethodID(cls, "codePointBefore", "(Ljava/lang/CharSequence;I)I");
        mids$[mid_codePointBefore_b92cf8f753e2d54d] = env->getStaticMethodID(cls, "codePointBefore", "([CII)I");
        mids$[mid_codePointCount_b92cf8f753e2d54d] = env->getStaticMethodID(cls, "codePointCount", "([CII)I");
        mids$[mid_codePointCount_ac2d5951f55781e5] = env->getStaticMethodID(cls, "codePointCount", "(Ljava/lang/CharSequence;II)I");
        mids$[mid_compare_ceb104e6e8561784] = env->getStaticMethodID(cls, "compare", "(CC)I");
        mids$[mid_compareTo_ccb6ad50e04c7425] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Character;)I");
        mids$[mid_digit_d9c0fd9859636e9e] = env->getStaticMethodID(cls, "digit", "(CI)I");
        mids$[mid_digit_3d7ede988f6b3a33] = env->getStaticMethodID(cls, "digit", "(II)I");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_forDigit_d85a8f7c376531ab] = env->getStaticMethodID(cls, "forDigit", "(II)C");
        mids$[mid_getDirectionality_c2f24e9c157e0376] = env->getStaticMethodID(cls, "getDirectionality", "(C)B");
        mids$[mid_getDirectionality_f76f53993d2cc81b] = env->getStaticMethodID(cls, "getDirectionality", "(I)B");
        mids$[mid_getName_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "getName", "(I)Ljava/lang/String;");
        mids$[mid_getNumericValue_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "getNumericValue", "(I)I");
        mids$[mid_getNumericValue_5e8f8009813d7b73] = env->getStaticMethodID(cls, "getNumericValue", "(C)I");
        mids$[mid_getType_5e8f8009813d7b73] = env->getStaticMethodID(cls, "getType", "(C)I");
        mids$[mid_getType_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "getType", "(I)I");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_5e8f8009813d7b73] = env->getStaticMethodID(cls, "hashCode", "(C)I");
        mids$[mid_highSurrogate_bdde8923c8d84ea7] = env->getStaticMethodID(cls, "highSurrogate", "(I)C");
        mids$[mid_isAlphabetic_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isAlphabetic", "(I)Z");
        mids$[mid_isBmpCodePoint_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isBmpCodePoint", "(I)Z");
        mids$[mid_isDefined_67259970fec09687] = env->getStaticMethodID(cls, "isDefined", "(C)Z");
        mids$[mid_isDefined_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isDefined", "(I)Z");
        mids$[mid_isDigit_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isDigit", "(I)Z");
        mids$[mid_isDigit_67259970fec09687] = env->getStaticMethodID(cls, "isDigit", "(C)Z");
        mids$[mid_isHighSurrogate_67259970fec09687] = env->getStaticMethodID(cls, "isHighSurrogate", "(C)Z");
        mids$[mid_isISOControl_67259970fec09687] = env->getStaticMethodID(cls, "isISOControl", "(C)Z");
        mids$[mid_isISOControl_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isISOControl", "(I)Z");
        mids$[mid_isIdentifierIgnorable_67259970fec09687] = env->getStaticMethodID(cls, "isIdentifierIgnorable", "(C)Z");
        mids$[mid_isIdentifierIgnorable_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isIdentifierIgnorable", "(I)Z");
        mids$[mid_isIdeographic_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isIdeographic", "(I)Z");
        mids$[mid_isJavaIdentifierPart_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isJavaIdentifierPart", "(I)Z");
        mids$[mid_isJavaIdentifierPart_67259970fec09687] = env->getStaticMethodID(cls, "isJavaIdentifierPart", "(C)Z");
        mids$[mid_isJavaIdentifierStart_67259970fec09687] = env->getStaticMethodID(cls, "isJavaIdentifierStart", "(C)Z");
        mids$[mid_isJavaIdentifierStart_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isJavaIdentifierStart", "(I)Z");
        mids$[mid_isJavaLetter_67259970fec09687] = env->getStaticMethodID(cls, "isJavaLetter", "(C)Z");
        mids$[mid_isJavaLetterOrDigit_67259970fec09687] = env->getStaticMethodID(cls, "isJavaLetterOrDigit", "(C)Z");
        mids$[mid_isLetter_67259970fec09687] = env->getStaticMethodID(cls, "isLetter", "(C)Z");
        mids$[mid_isLetter_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isLetter", "(I)Z");
        mids$[mid_isLetterOrDigit_67259970fec09687] = env->getStaticMethodID(cls, "isLetterOrDigit", "(C)Z");
        mids$[mid_isLetterOrDigit_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isLetterOrDigit", "(I)Z");
        mids$[mid_isLowSurrogate_67259970fec09687] = env->getStaticMethodID(cls, "isLowSurrogate", "(C)Z");
        mids$[mid_isLowerCase_67259970fec09687] = env->getStaticMethodID(cls, "isLowerCase", "(C)Z");
        mids$[mid_isLowerCase_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isLowerCase", "(I)Z");
        mids$[mid_isMirrored_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isMirrored", "(I)Z");
        mids$[mid_isMirrored_67259970fec09687] = env->getStaticMethodID(cls, "isMirrored", "(C)Z");
        mids$[mid_isSpace_67259970fec09687] = env->getStaticMethodID(cls, "isSpace", "(C)Z");
        mids$[mid_isSpaceChar_67259970fec09687] = env->getStaticMethodID(cls, "isSpaceChar", "(C)Z");
        mids$[mid_isSpaceChar_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isSpaceChar", "(I)Z");
        mids$[mid_isSupplementaryCodePoint_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isSupplementaryCodePoint", "(I)Z");
        mids$[mid_isSurrogate_67259970fec09687] = env->getStaticMethodID(cls, "isSurrogate", "(C)Z");
        mids$[mid_isSurrogatePair_14ab155827503d09] = env->getStaticMethodID(cls, "isSurrogatePair", "(CC)Z");
        mids$[mid_isTitleCase_67259970fec09687] = env->getStaticMethodID(cls, "isTitleCase", "(C)Z");
        mids$[mid_isTitleCase_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isTitleCase", "(I)Z");
        mids$[mid_isUnicodeIdentifierPart_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isUnicodeIdentifierPart", "(I)Z");
        mids$[mid_isUnicodeIdentifierPart_67259970fec09687] = env->getStaticMethodID(cls, "isUnicodeIdentifierPart", "(C)Z");
        mids$[mid_isUnicodeIdentifierStart_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isUnicodeIdentifierStart", "(I)Z");
        mids$[mid_isUnicodeIdentifierStart_67259970fec09687] = env->getStaticMethodID(cls, "isUnicodeIdentifierStart", "(C)Z");
        mids$[mid_isUpperCase_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isUpperCase", "(I)Z");
        mids$[mid_isUpperCase_67259970fec09687] = env->getStaticMethodID(cls, "isUpperCase", "(C)Z");
        mids$[mid_isValidCodePoint_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isValidCodePoint", "(I)Z");
        mids$[mid_isWhitespace_67259970fec09687] = env->getStaticMethodID(cls, "isWhitespace", "(C)Z");
        mids$[mid_isWhitespace_ac5e1ea02cadda84] = env->getStaticMethodID(cls, "isWhitespace", "(I)Z");
        mids$[mid_lowSurrogate_bdde8923c8d84ea7] = env->getStaticMethodID(cls, "lowSurrogate", "(I)C");
        mids$[mid_offsetByCodePoints_ac2d5951f55781e5] = env->getStaticMethodID(cls, "offsetByCodePoints", "(Ljava/lang/CharSequence;II)I");
        mids$[mid_offsetByCodePoints_45e91eb00e10c606] = env->getStaticMethodID(cls, "offsetByCodePoints", "([CIIII)I");
        mids$[mid_reverseBytes_d1464336d7bee138] = env->getStaticMethodID(cls, "reverseBytes", "(C)C");
        mids$[mid_toChars_0267698bd3da4f10] = env->getStaticMethodID(cls, "toChars", "(I)[C");
        mids$[mid_toChars_3ac70d32bee56269] = env->getStaticMethodID(cls, "toChars", "(I[CI)I");
        mids$[mid_toCodePoint_ceb104e6e8561784] = env->getStaticMethodID(cls, "toCodePoint", "(CC)I");
        mids$[mid_toLowerCase_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "toLowerCase", "(I)I");
        mids$[mid_toLowerCase_d1464336d7bee138] = env->getStaticMethodID(cls, "toLowerCase", "(C)C");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_82ceb9edccd24fa3] = env->getStaticMethodID(cls, "toString", "(C)Ljava/lang/String;");
        mids$[mid_toTitleCase_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "toTitleCase", "(I)I");
        mids$[mid_toTitleCase_d1464336d7bee138] = env->getStaticMethodID(cls, "toTitleCase", "(C)C");
        mids$[mid_toUpperCase_d1464336d7bee138] = env->getStaticMethodID(cls, "toUpperCase", "(C)C");
        mids$[mid_toUpperCase_4b23a339ec27bbb3] = env->getStaticMethodID(cls, "toUpperCase", "(I)I");
        mids$[mid_valueOf_498158d66926f36f] = env->getStaticMethodID(cls, "valueOf", "(C)Ljava/lang/Character;");
    ...
    Character::Character(jchar a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_1e3a1ae808486483, a0)) {}

    jint Character::charCount(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_charCount_4b23a339ec27bbb3], a0);
    }

    jchar Character::charValue() const
    {
      return env->callCharMethod(this$, mids$[mid_charValue_27667b9767feeda0]);
    }

    jint Character::codePointAt(const JArray< jchar > & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointAt_98218a2785b3f776], a0.this$, a1);
    }

    jint Character::codePointAt(const ::java::lang::CharSequence & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointAt_4c67fb52be240c28], a0.this$, a1);
    }

    jint Character::codePointAt(const JArray< jchar > & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointAt_b92cf8f753e2d54d], a0.this$, a1, a2);
    }

    jint Character::codePointBefore(const JArray< jchar > & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointBefore_98218a2785b3f776], a0.this$, a1);
    }

    jint Character::codePointBefore(const ::java::lang::CharSequence & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointBefore_4c67fb52be240c28], a0.this$, a1);
    }

    jint Character::codePointBefore(const JArray< jchar > & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointBefore_b92cf8f753e2d54d], a0.this$, a1, a2);
    }

    jint Character::codePointCount(const JArray< jchar > & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointCount_b92cf8f753e2d54d], a0.this$, a1, a2);
    }

    jint Character::codePointCount(const ::java::lang::CharSequence & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_codePointCount_ac2d5951f55781e5], a0.this$, a1, a2);
    }

    jint Character::compare(jchar a0, jchar a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_ceb104e6e8561784], a0, a1);
    }

    jint Character::compareTo(const Character & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_ccb6ad50e04c7425], a0.this$);
    }

    jint Character::digit(jchar a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_digit_d9c0fd9859636e9e], a0, a1);
    }

    jint Character::digit(jint a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_digit_3d7ede988f6b3a33], a0, a1);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_forDigit_d85a8f7c376531ab], a0, a1);
    }

    jbyte Character::getDirectionality(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticByteMethod(cls, mids$[mid_getDirectionality_c2f24e9c157e0376], a0);
    }

    jbyte Character::getDirectionality(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticByteMethod(cls, mids$[mid_getDirectionality_f76f53993d2cc81b], a0);
    }

    ::java::lang::String Character::getName(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_getName_ab09aaf2e63107e3], a0));
    }

    jint Character::getNumericValue(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_getNumericValue_4b23a339ec27bbb3], a0);
    }

    jint Character::getNumericValue(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_getNumericValue_5e8f8009813d7b73], a0);
    }

    jint Character::getType(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_getType_5e8f8009813d7b73], a0);
    }

    jint Character::getType(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_getType_4b23a339ec27bbb3], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_5e8f8009813d7b73], a0);
    }

    jchar Character::highSurrogate(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_highSurrogate_bdde8923c8d84ea7], a0);
    }

    jboolean Character::isAlphabetic(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isAlphabetic_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isBmpCodePoint(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isBmpCodePoint_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isDefined(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isDefined_67259970fec09687], a0);
    }

    jboolean Character::isDefined(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isDefined_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isDigit(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isDigit_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isDigit(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isDigit_67259970fec09687], a0);
    }

    jboolean Character::isHighSurrogate(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isHighSurrogate_67259970fec09687], a0);
    }

    jboolean Character::isISOControl(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isISOControl_67259970fec09687], a0);
    }

    jboolean Character::isISOControl(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isISOControl_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isIdentifierIgnorable(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isIdentifierIgnorable_67259970fec09687], a0);
    }

    jboolean Character::isIdentifierIgnorable(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isIdentifierIgnorable_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isIdeographic(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isIdeographic_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isJavaIdentifierPart(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaIdentifierPart_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isJavaIdentifierPart(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaIdentifierPart_67259970fec09687], a0);
    }

    jboolean Character::isJavaIdentifierStart(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaIdentifierStart_67259970fec09687], a0);
    }

    jboolean Character::isJavaIdentifierStart(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaIdentifierStart_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isJavaLetter(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaLetter_67259970fec09687], a0);
    }

    jboolean Character::isJavaLetterOrDigit(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isJavaLetterOrDigit_67259970fec09687], a0);
    }

    jboolean Character::isLetter(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLetter_67259970fec09687], a0);
    }

    jboolean Character::isLetter(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLetter_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isLetterOrDigit(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLetterOrDigit_67259970fec09687], a0);
    }

    jboolean Character::isLetterOrDigit(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLetterOrDigit_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isLowSurrogate(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLowSurrogate_67259970fec09687], a0);
    }

    jboolean Character::isLowerCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLowerCase_67259970fec09687], a0);
    }

    jboolean Character::isLowerCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isLowerCase_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isMirrored(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isMirrored_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isMirrored(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isMirrored_67259970fec09687], a0);
    }

    jboolean Character::isSpace(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSpace_67259970fec09687], a0);
    }

    jboolean Character::isSpaceChar(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSpaceChar_67259970fec09687], a0);
    }

    jboolean Character::isSpaceChar(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSpaceChar_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isSupplementaryCodePoint(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSupplementaryCodePoint_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isSurrogate(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSurrogate_67259970fec09687], a0);
    }

    jboolean Character::isSurrogatePair(jchar a0, jchar a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isSurrogatePair_14ab155827503d09], a0, a1);
    }

    jboolean Character::isTitleCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isTitleCase_67259970fec09687], a0);
    }

    jboolean Character::isTitleCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isTitleCase_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isUnicodeIdentifierPart(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUnicodeIdentifierPart_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isUnicodeIdentifierPart(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUnicodeIdentifierPart_67259970fec09687], a0);
    }

    jboolean Character::isUnicodeIdentifierStart(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUnicodeIdentifierStart_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isUnicodeIdentifierStart(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUnicodeIdentifierStart_67259970fec09687], a0);
    }

    jboolean Character::isUpperCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUpperCase_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isUpperCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isUpperCase_67259970fec09687], a0);
    }

    jboolean Character::isValidCodePoint(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isValidCodePoint_ac5e1ea02cadda84], a0);
    }

    jboolean Character::isWhitespace(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isWhitespace_67259970fec09687], a0);
    }

    jboolean Character::isWhitespace(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isWhitespace_ac5e1ea02cadda84], a0);
    }

    jchar Character::lowSurrogate(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_lowSurrogate_bdde8923c8d84ea7], a0);
    }

    jint Character::offsetByCodePoints(const ::java::lang::CharSequence & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_offsetByCodePoints_ac2d5951f55781e5], a0.this$, a1, a2);
    }

    jint Character::offsetByCodePoints(const JArray< jchar > & a0, jint a1, jint a2, jint a3, jint a4)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_offsetByCodePoints_45e91eb00e10c606], a0.this$, a1, a2, a3, a4);
    }

    jchar Character::reverseBytes(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_reverseBytes_d1464336d7bee138], a0);
    }

    JArray< jchar > Character::toChars(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return JArray< jchar >(env->callStaticObjectMethod(cls, mids$[mid_toChars_0267698bd3da4f10], a0));
    }

    jint Character::toChars(jint a0, const JArray< jchar > & a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toChars_3ac70d32bee56269], a0, a1.this$, a2);
    }

    jint Character::toCodePoint(jchar a0, jchar a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toCodePoint_ceb104e6e8561784], a0, a1);
    }

    jint Character::toLowerCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toLowerCase_4b23a339ec27bbb3], a0);
    }

    jchar Character::toLowerCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_toLowerCase_d1464336d7bee138], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_82ceb9edccd24fa3], a0));
    }

    jint Character::toTitleCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toTitleCase_4b23a339ec27bbb3], a0);
    }

    jchar Character::toTitleCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_toTitleCase_d1464336d7bee138], a0);
    }

    jchar Character::toUpperCase(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticCharMethod(cls, mids$[mid_toUpperCase_d1464336d7bee138], a0);
    }

    jint Character::toUpperCase(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toUpperCase_4b23a339ec27bbb3], a0);
    }

    Character Character::valueOf(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Character(env->callStaticObjectMethod(cls, mids$[mid_valueOf_498158d66926f36f], a0));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Byte::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_4ae782e2002f2005] = env->getMethodID(cls, "<init>", "(B)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_dd3bab549f1269ef] = env->getStaticMethodID(cls, "compare", "(BB)I");
        mids$[mid_compareTo_580c045618437d83] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Byte;)I");
        mids$[mid_decode_52f1cac43c85245c] = env->getStaticMethodID(cls, "decode", "(Ljava/lang/String;)Ljava/lang/Byte;");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_d509c008f6ebc11d] = env->getStaticMethodID(cls, "hashCode", "(B)I");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_parseByte_33060f793072446b] = env->getStaticMethodID(cls, "parseByte", "(Ljava/lang/String;)B");
        mids$[mid_parseByte_fd1a035ce7af79d1] = env->getStaticMethodID(cls, "parseByte", "(Ljava/lang/String;I)B");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_3e2d3cc2f2361bf0] = env->getStaticMethodID(cls, "toString", "(B)Ljava/lang/String;");
        mids$[mid_toUnsignedInt_d509c008f6ebc11d] = env->getStaticMethodID(cls, "toUnsignedInt", "(B)I");
        mids$[mid_toUnsignedLong_78c495804247ba9f] = env->getStaticMethodID(cls, "toUnsignedLong", "(B)J");
        mids$[mid_valueOf_c1bf298dc5c7510b] = env->getStaticMethodID(cls, "valueOf", "(B)Ljava/lang/Byte;");
        mids$[mid_valueOf_52f1cac43c85245c] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Byte;");
        mids$[mid_valueOf_94243246b4507eee] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;I)Ljava/lang/Byte;");
    ...
    Byte::Byte(jbyte a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_4ae782e2002f2005, a0)) {}

    Byte::Byte(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_dd3bab549f1269ef], a0, a1);
    }

    jint Byte::compareTo(const Byte & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_580c045618437d83], a0.this$);
    }

    Byte Byte::decode(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Byte(env->callStaticObjectMethod(cls, mids$[mid_decode_52f1cac43c85245c], a0.this$));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_d509c008f6ebc11d], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticByteMethod(cls, mids$[mid_parseByte_33060f793072446b], a0.this$);
    }

    jbyte Byte::parseByte(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticByteMethod(cls, mids$[mid_parseByte_fd1a035ce7af79d1], a0.this$, a1);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_3e2d3cc2f2361bf0], a0));
    }

    jint Byte::toUnsignedInt(jbyte a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_toUnsignedInt_d509c008f6ebc11d], a0);
    }

    jlong Byte::toUnsignedLong(jbyte a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_toUnsignedLong_78c495804247ba9f], a0);
    }

    Byte Byte::valueOf(jbyte a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Byte(env->callStaticObjectMethod(cls, mids$[mid_valueOf_c1bf298dc5c7510b], a0));
    }

    Byte Byte::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Byte(env->callStaticObjectMethod(cls, mids$[mid_valueOf_52f1cac43c85245c], a0.this$));
    }

    Byte Byte::valueOf(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Byte(env->callStaticObjectMethod(cls, mids$[mid_valueOf_94243246b4507eee], a0.this$, a1));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Float::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_4454b3633e331cef] = env->getMethodID(cls, "<init>", "(D)V");
        mids$[mid_init$_00f6aa63d2ba4dac] = env->getMethodID(cls, "<init>", "(F)V");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_0df13f9617dc5d35] = env->getStaticMethodID(cls, "compare", "(FF)I");
        mids$[mid_compareTo_e492dc46818c27ee] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Float;)I");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatToIntBits_4b148a9e1a682ecf] = env->getStaticMethodID(cls, "floatToIntBits", "(F)I");
        mids$[mid_floatToRawIntBits_4b148a9e1a682ecf] = env->getStaticMethodID(cls, "floatToRawIntBits", "(F)I");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_4b148a9e1a682ecf] = env->getStaticMethodID(cls, "hashCode", "(F)I");
        mids$[mid_intBitsToFloat_8c1eea33f02c2c30] = env->getStaticMethodID(cls, "intBitsToFloat", "(I)F");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_isFinite_ed9bbe984b7c6385] = env->getStaticMethodID(cls, "isFinite", "(F)Z");
        mids$[mid_isInfinite_318f7cae9d6a33e6] = env->getMethodID(cls, "isInfinite", "()Z");
        mids$[mid_isInfinite_ed9bbe984b7c6385] = env->getStaticMethodID(cls, "isInfinite", "(F)Z");
        mids$[mid_isNaN_318f7cae9d6a33e6] = env->getMethodID(cls, "isNaN", "()Z");
        mids$[mid_isNaN_ed9bbe984b7c6385] = env->getStaticMethodID(cls, "isNaN", "(F)Z");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_max_6b6277a645ad3dea] = env->getStaticMethodID(cls, "max", "(FF)F");
        mids$[mid_min_6b6277a645ad3dea] = env->getStaticMethodID(cls, "min", "(FF)F");
        mids$[mid_parseFloat_b146d86f2dc2ae35] = env->getStaticMethodID(cls, "parseFloat", "(Ljava/lang/String;)F");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_sum_6b6277a645ad3dea] = env->getStaticMethodID(cls, "sum", "(FF)F");
        mids$[mid_toHexString_3ef4f0a5c27c2560] = env->getStaticMethodID(cls, "toHexString", "(F)Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_3ef4f0a5c27c2560] = env->getStaticMethodID(cls, "toString", "(F)Ljava/lang/String;");
        mids$[mid_valueOf_aba530a5b0b9f932] = env->getStaticMethodID(cls, "valueOf", "(F)Ljava/lang/Float;");
        mids$[mid_valueOf_cccf8ad87309d98e] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Float;");
    ...
    Float::Float(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    Float::Float(jdouble a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_4454b3633e331cef, a0)) {}

    Float::Float(jfloat a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_00f6aa63d2ba4dac, a0)) {}
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_0df13f9617dc5d35], a0, a1);
    }

    jint Float::compareTo(const Float & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_e492dc46818c27ee], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_floatToIntBits_4b148a9e1a682ecf], a0);
    }

    jint Float::floatToRawIntBits(jfloat a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_floatToRawIntBits_4b148a9e1a682ecf], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_4b148a9e1a682ecf], a0);
    }

    jfloat Float::intBitsToFloat(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticFloatMethod(cls, mids$[mid_intBitsToFloat_8c1eea33f02c2c30], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isFinite_ed9bbe984b7c6385], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isInfinite_ed9bbe984b7c6385], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticBooleanMethod(cls, mids$[mid_isNaN_ed9bbe984b7c6385], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticFloatMethod(cls, mids$[mid_max_6b6277a645ad3dea], a0, a1);
    }

    jfloat Float::min$(jfloat a0, jfloat a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticFloatMethod(cls, mids$[mid_min_6b6277a645ad3dea], a0, a1);
    }

    jfloat Float::parseFloat(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticFloatMethod(cls, mids$[mid_parseFloat_b146d86f2dc2ae35], a0.this$);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticFloatMethod(cls, mids$[mid_sum_6b6277a645ad3dea], a0, a1);
    }

    ::java::lang::String Float::toHexString(jfloat a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toHexString_3ef4f0a5c27c2560], a0));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_3ef4f0a5c27c2560], a0));
    }

    Float Float::valueOf(jfloat a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Float(env->callStaticObjectMethod(cls, mids$[mid_valueOf_aba530a5b0b9f932], a0));
    }

    Float Float::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Float(env->callStaticObjectMethod(cls, mids$[mid_valueOf_cccf8ad87309d98e], a0.this$));
    }
  }
}
  ...
  namespace util {
    ...
    jclass Enumeration::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_hasMoreElements_318f7cae9d6a33e6] = env->getMethodID(cls, "hasMoreElements", "()Z");
        mids$[mid_nextElement_6a490f1da80a3003] = env->getMethodID(cls, "nextElement", "()Ljava/lang/Object;");
    ...
    {
      return env->callBooleanMethod(this$, mids$[mid_hasMoreElements_318f7cae9d6a33e6]);
    }

    ::java::lang::Object Enumeration::nextElement() const
    {
      return ::java::lang::Object(env->callObjectMethod(this$, mids$[mid_nextElement_6a490f1da80a3003]));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Throwable::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_5df017320dfbf543] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V");
        mids$[mid_addSuppressed_359aa6a1d41f0219] = env->getMethodID(cls, "addSuppressed", "(Ljava/lang/Throwable;)V");
        mids$[mid_fillInStackTrace_81fe1f12b87f141b] = env->getMethodID(cls, "fillInStackTrace", "()Ljava/lang/Throwable;");
        mids$[mid_getCause_81fe1f12b87f141b] = env->getMethodID(cls, "getCause", "()Ljava/lang/Throwable;");
        mids$[mid_getLocalizedMessage_c041e21e63165d2d] = env->getMethodID(cls, "getLocalizedMessage", "()Ljava/lang/String;");
        mids$[mid_getMessage_c041e21e63165d2d] = env->getMethodID(cls, "getMessage", "()Ljava/lang/String;");
        mids$[mid_getStackTrace_c4e857717549de1a] = env->getMethodID(cls, "getStackTrace", "()[Ljava/lang/StackTraceElement;");
        mids$[mid_getSuppressed_58ff4eb97ed3fe96] = env->getMethodID(cls, "getSuppressed", "()[Ljava/lang/Throwable;");
        mids$[mid_initCause_bcdf3ac5798fea3a] = env->getMethodID(cls, "initCause", "(Ljava/lang/Throwable;)Ljava/lang/Throwable;");
        mids$[mid_printStackTrace_3b7a1d3d26162b85] = env->getMethodID(cls, "printStackTrace", "()V");
        mids$[mid_printStackTrace_d60231ec0f744a70] = env->getMethodID(cls, "printStackTrace", "(Ljava/io/PrintWriter;)V");
        mids$[mid_setStackTrace_5e3c0689cd8db190] = env->getMethodID(cls, "setStackTrace", "([Ljava/lang/StackTraceElement;)V");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
    ...
    Throwable::Throwable() : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    Throwable::Throwable(const ::java::lang::String & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    Throwable::Throwable(const ::java::lang::String & a0, const Throwable & a1) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}

    void Throwable::addSuppressed(const Throwable & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_addSuppressed_359aa6a1d41f0219], a0.this$);
    }

    Throwable Throwable::fillInStackTrace() const
    {
      return Throwable(env->callObjectMethod(this$, mids$[mid_fillInStackTrace_81fe1f12b87f141b]));
    }

    Throwable Throwable::getCause() const
    {
      return Throwable(env->callObjectMethod(this$, mids$[mid_getCause_81fe1f12b87f141b]));
    }

    ::java::lang::String Throwable::getLocalizedMessage() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getLocalizedMessage_c041e21e63165d2d]));
    }

    ::java::lang::String Throwable::getMessage() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getMessage_c041e21e63165d2d]));
    }

    JArray< ::java::lang::StackTraceElement > Throwable::getStackTrace() const
    {
      return JArray< ::java::lang::StackTraceElement >(env->callObjectMethod(this$, mids$[mid_getStackTrace_c4e857717549de1a]));
    }

    JArray< Throwable > Throwable::getSuppressed() const
    {
      return JArray< Throwable >(env->callObjectMethod(this$, mids$[mid_getSuppressed_58ff4eb97ed3fe96]));
    }

    Throwable Throwable::initCause(const Throwable & a0) const
    {
      return Throwable(env->callObjectMethod(this$, mids$[mid_initCause_bcdf3ac5798fea3a], a0.this$));
    }

    void Throwable::printStackTrace() const
    {
      env->callVoidMethod(this$, mids$[mid_printStackTrace_3b7a1d3d26162b85]);
    }

    void Throwable::printStackTrace(const ::java::io::PrintWriter & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_printStackTrace_d60231ec0f744a70], a0.this$);
    }

    void Throwable::setStackTrace(const JArray< ::java::lang::StackTraceElement > & a0) const
    {
      env->callVoidMethod(this$, mids$[mid_setStackTrace_5e3c0689cd8db190], a0.this$);
    }
...
namespace jcc_test {
  ...
  ::java::lang::Class *HelloJCC::class$ = NULL;
  jmethodID *HelloJCC::mids$ = NULL;
  bool HelloJCC::live$ = false;

  jclass HelloJCC::initializeClass(bool getOnly)
  {
    if (getOnly)
      return (jclass) (live$ ? class$->this$ : NULL);
    if (class$ == NULL)
    {
      jclass cls = (jclass) env->findClass("jcc_test/HelloJCC");

      mids$ = new jmethodID[max_mid];
      mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
      mids$[mid_init$_62ca3504c6e80f45] = env->getMethodID(cls, "<init>", "(Ljava/lang/Integer;)V");
      mids$[mid_main_93dc42246c5a16dc] = env->getStaticMethodID(cls, "main", "([Ljava/lang/String;)V");
  ...
  HelloJCC::HelloJCC(const ::java::lang::String & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

  HelloJCC::HelloJCC(const ::java::lang::Integer & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_62ca3504c6e80f45, a0.this$)) {}

  void HelloJCC::main(const JArray< ::java::lang::String > & a0)
  {
    jclass cls = env->getClass(initializeClass);
    env->callStaticVoidMethod(cls, mids$[mid_main_93dc42246c5a16dc], a0.this$);
  }
}
...
namespace jcc_test {
  static PyObject *t_HelloJCC_cast_(PyTypeObject *type, PyObject *arg);
  static PyObject *t_HelloJCC_instance_(PyTypeObject *type, PyObject *arg);
  static int t_HelloJCC_init_(t_HelloJCC *self, PyObject *args, PyObject *kwds);
  static PyObject *t_HelloJCC_main(PyTypeObject *type, PyObject *arg);

  static PyMethodDef t_HelloJCC__methods_[] = {
    DECLARE_METHOD(t_HelloJCC, cast_, METH_O | METH_CLASS),
    DECLARE_METHOD(t_HelloJCC, instance_, METH_O | METH_CLASS),
    DECLARE_METHOD(t_HelloJCC, main, METH_O | METH_CLASS),
    { NULL, NULL, 0, NULL }
  };

  DECLARE_TYPE(HelloJCC, t_HelloJCC, ::java::lang::Object, HelloJCC, t_HelloJCC_init_, 0, 0, 0, 0, 0);

  void t_HelloJCC::install(PyObject *module)
  {
    installType(&PY_TYPE(HelloJCC), module, "HelloJCC", 0);
  }

  void t_HelloJCC::initialize(PyObject *module)
  {
    PyDict_SetItemString(PY_TYPE(HelloJCC).tp_dict, "class_", make_descriptor(HelloJCC::initializeClass, 1));
    PyDict_SetItemString(PY_TYPE(HelloJCC).tp_dict, "wrapfn_", make_descriptor(t_HelloJCC::wrap_jobject));
    PyDict_SetItemString(PY_TYPE(HelloJCC).tp_dict, "boxfn_", make_descriptor(boxObject));
  }

  static PyObject *t_HelloJCC_cast_(PyTypeObject *type, PyObject *arg)
  {
    if (!(arg = castCheck(arg, HelloJCC::initializeClass, 1)))
      return NULL;
    return t_HelloJCC::wrap_Object(HelloJCC(((t_HelloJCC *) arg)->object.this$));
  }
  static PyObject *t_HelloJCC_instance_(PyTypeObject *type, PyObject *arg)
  {
    if (!castCheck(arg, HelloJCC::initializeClass, 0))
      Py_RETURN_FALSE;
    Py_RETURN_TRUE;
  }
  ...
  static int t_HelloJCC_init_(t_HelloJCC *self, PyObject *args, PyObject *kwds)
  {
    switch (PyTuple_GET_SIZE(args)) {
     case 1:
      {
        ::java::lang::String a0((jobject) NULL);
        HelloJCC object((jobject) NULL);

        if (!parseArgs(args, "s", &a0))
        {
          INT_CALL(object = HelloJCC(a0));
          self->object = object;
          break;
        }
      }
  ...
  static PyObject *t_HelloJCC_main(PyTypeObject *type, PyObject *arg)
  {
    ...
    if (!parseArg(arg, "[s", &a0))
    {
      OBJ_CALL(::jcc_test::HelloJCC::main(a0));
      Py_RETURN_NONE;
    }
  ...
  namespace lang {
    ...
    jclass Long::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_625495ddbdca45a4] = env->getMethodID(cls, "<init>", "(J)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_bitCount_4a7f4b32ae8bb7df] = env->getStaticMethodID(cls, "bitCount", "(J)I");
        mids$[mid_byteValue_51018f1683a6b595] = env->getMethodID(cls, "byteValue", "()B");
        mids$[mid_compare_f033cbd575b7105c] = env->getStaticMethodID(cls, "compare", "(JJ)I");
        mids$[mid_compareTo_30a45e2465c4f803] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Long;)I");
        mids$[mid_compareUnsigned_f033cbd575b7105c] = env->getStaticMethodID(cls, "compareUnsigned", "(JJ)I");
        mids$[mid_decode_42b4fca39337a097] = env->getStaticMethodID(cls, "decode", "(Ljava/lang/String;)Ljava/lang/Long;");
        mids$[mid_divideUnsigned_474e7493390ce6aa] = env->getStaticMethodID(cls, "divideUnsigned", "(JJ)J");
        mids$[mid_doubleValue_746fdfc2336a8dce] = env->getMethodID(cls, "doubleValue", "()D");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_floatValue_4e51965d8682d4e7] = env->getMethodID(cls, "floatValue", "()F");
        mids$[mid_getLong_42b4fca39337a097] = env->getStaticMethodID(cls, "getLong", "(Ljava/lang/String;)Ljava/lang/Long;");
        mids$[mid_getLong_bf939d72284a459a] = env->getStaticMethodID(cls, "getLong", "(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/Long;");
        mids$[mid_getLong_9cad517bf35ef2fe] = env->getStaticMethodID(cls, "getLong", "(Ljava/lang/String;J)Ljava/lang/Long;");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_hashCode_4a7f4b32ae8bb7df] = env->getStaticMethodID(cls, "hashCode", "(J)I");
        mids$[mid_highestOneBit_260a8e55c4f9b69d] = env->getStaticMethodID(cls, "highestOneBit", "(J)J");
        mids$[mid_intValue_60df5a771df5b62d] = env->getMethodID(cls, "intValue", "()I");
        mids$[mid_longValue_0a482dcd1f56375a] = env->getMethodID(cls, "longValue", "()J");
        mids$[mid_lowestOneBit_260a8e55c4f9b69d] = env->getStaticMethodID(cls, "lowestOneBit", "(J)J");
        mids$[mid_max_474e7493390ce6aa] = env->getStaticMethodID(cls, "max", "(JJ)J");
        mids$[mid_min_474e7493390ce6aa] = env->getStaticMethodID(cls, "min", "(JJ)J");
        mids$[mid_numberOfLeadingZeros_4a7f4b32ae8bb7df] = env->getStaticMethodID(cls, "numberOfLeadingZeros", "(J)I");
        mids$[mid_numberOfTrailingZeros_4a7f4b32ae8bb7df] = env->getStaticMethodID(cls, "numberOfTrailingZeros", "(J)I");
        mids$[mid_parseLong_0cbca90ccd99e162] = env->getStaticMethodID(cls, "parseLong", "(Ljava/lang/String;)J");
        mids$[mid_parseLong_1d398dbe6cfcf1c4] = env->getStaticMethodID(cls, "parseLong", "(Ljava/lang/String;I)J");
        mids$[mid_parseUnsignedLong_0cbca90ccd99e162] = env->getStaticMethodID(cls, "parseUnsignedLong", "(Ljava/lang/String;)J");
        mids$[mid_parseUnsignedLong_1d398dbe6cfcf1c4] = env->getStaticMethodID(cls, "parseUnsignedLong", "(Ljava/lang/String;I)J");
        mids$[mid_remainderUnsigned_474e7493390ce6aa] = env->getStaticMethodID(cls, "remainderUnsigned", "(JJ)J");
        mids$[mid_reverse_260a8e55c4f9b69d] = env->getStaticMethodID(cls, "reverse", "(J)J");
        mids$[mid_reverseBytes_260a8e55c4f9b69d] = env->getStaticMethodID(cls, "reverseBytes", "(J)J");
        mids$[mid_rotateLeft_f14cb9e7584956e9] = env->getStaticMethodID(cls, "rotateLeft", "(JI)J");
        mids$[mid_rotateRight_f14cb9e7584956e9] = env->getStaticMethodID(cls, "rotateRight", "(JI)J");
        mids$[mid_shortValue_3e271dc4ae1ecc4b] = env->getMethodID(cls, "shortValue", "()S");
        mids$[mid_signum_4a7f4b32ae8bb7df] = env->getStaticMethodID(cls, "signum", "(J)I");
        mids$[mid_sum_474e7493390ce6aa] = env->getStaticMethodID(cls, "sum", "(JJ)J");
        mids$[mid_toBinaryString_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "toBinaryString", "(J)Ljava/lang/String;");
        mids$[mid_toHexString_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "toHexString", "(J)Ljava/lang/String;");
        mids$[mid_toOctalString_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "toOctalString", "(J)Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toString_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "toString", "(J)Ljava/lang/String;");
        mids$[mid_toString_25349188bff6632a] = env->getStaticMethodID(cls, "toString", "(JI)Ljava/lang/String;");
        mids$[mid_toUnsignedString_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "toUnsignedString", "(J)Ljava/lang/String;");
        mids$[mid_toUnsignedString_25349188bff6632a] = env->getStaticMethodID(cls, "toUnsignedString", "(JI)Ljava/lang/String;");
        mids$[mid_valueOf_f71a75af73ce322a] = env->getStaticMethodID(cls, "valueOf", "(J)Ljava/lang/Long;");
        mids$[mid_valueOf_42b4fca39337a097] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;)Ljava/lang/Long;");
        mids$[mid_valueOf_1fe189246c742b8a] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/String;I)Ljava/lang/Long;");
    ...
    Long::Long(jlong a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_625495ddbdca45a4, a0)) {}

    Long::Long(const ::java::lang::String & a0) : ::java::lang::Number(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    jint Long::bitCount(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_bitCount_4a7f4b32ae8bb7df], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compare_f033cbd575b7105c], a0, a1);
    }

    jint Long::compareTo(const Long & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_30a45e2465c4f803], a0.this$);
    }

    jint Long::compareUnsigned(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_compareUnsigned_f033cbd575b7105c], a0, a1);
    }

    Long Long::decode(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_decode_42b4fca39337a097], a0.this$));
    }

    jlong Long::divideUnsigned(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_divideUnsigned_474e7493390ce6aa], a0, a1);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_getLong_42b4fca39337a097], a0.this$));
    }

    Long Long::getLong(const ::java::lang::String & a0, const Long & a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_getLong_bf939d72284a459a], a0.this$, a1.this$));
    }

    Long Long::getLong(const ::java::lang::String & a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_getLong_9cad517bf35ef2fe], a0.this$, a1));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_hashCode_4a7f4b32ae8bb7df], a0);
    }

    jlong Long::highestOneBit(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_highestOneBit_260a8e55c4f9b69d], a0);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_lowestOneBit_260a8e55c4f9b69d], a0);
    }

    jlong Long::max$(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_max_474e7493390ce6aa], a0, a1);
    }

    jlong Long::min$(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_min_474e7493390ce6aa], a0, a1);
    }

    jint Long::numberOfLeadingZeros(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_numberOfLeadingZeros_4a7f4b32ae8bb7df], a0);
    }

    jint Long::numberOfTrailingZeros(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_numberOfTrailingZeros_4a7f4b32ae8bb7df], a0);
    }

    jlong Long::parseLong(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_parseLong_0cbca90ccd99e162], a0.this$);
    }

    jlong Long::parseLong(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_parseLong_1d398dbe6cfcf1c4], a0.this$, a1);
    }

    jlong Long::parseUnsignedLong(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_parseUnsignedLong_0cbca90ccd99e162], a0.this$);
    }

    jlong Long::parseUnsignedLong(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_parseUnsignedLong_1d398dbe6cfcf1c4], a0.this$, a1);
    }

    jlong Long::remainderUnsigned(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_remainderUnsigned_474e7493390ce6aa], a0, a1);
    }

    jlong Long::reverse(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_reverse_260a8e55c4f9b69d], a0);
    }

    jlong Long::reverseBytes(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_reverseBytes_260a8e55c4f9b69d], a0);
    }

    jlong Long::rotateLeft(jlong a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_rotateLeft_f14cb9e7584956e9], a0, a1);
    }

    jlong Long::rotateRight(jlong a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_rotateRight_f14cb9e7584956e9], a0, a1);
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticIntMethod(cls, mids$[mid_signum_4a7f4b32ae8bb7df], a0);
    }

    jlong Long::sum(jlong a0, jlong a1)
    {
      jclass cls = env->getClass(initializeClass);
      return env->callStaticLongMethod(cls, mids$[mid_sum_474e7493390ce6aa], a0, a1);
    }

    ::java::lang::String Long::toBinaryString(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toBinaryString_6cc2f594436f7b3d], a0));
    }

    ::java::lang::String Long::toHexString(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toHexString_6cc2f594436f7b3d], a0));
    }

    ::java::lang::String Long::toOctalString(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toOctalString_6cc2f594436f7b3d], a0));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_6cc2f594436f7b3d], a0));
    }

    ::java::lang::String Long::toString(jlong a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toString_25349188bff6632a], a0, a1));
    }

    ::java::lang::String Long::toUnsignedString(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toUnsignedString_6cc2f594436f7b3d], a0));
    }

    ::java::lang::String Long::toUnsignedString(jlong a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return ::java::lang::String(env->callStaticObjectMethod(cls, mids$[mid_toUnsignedString_25349188bff6632a], a0, a1));
    }

    Long Long::valueOf(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_valueOf_f71a75af73ce322a], a0));
    }

    Long Long::valueOf(const ::java::lang::String & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_valueOf_42b4fca39337a097], a0.this$));
    }

    Long Long::valueOf(const ::java::lang::String & a0, jint a1)
    {
      jclass cls = env->getClass(initializeClass);
      return Long(env->callStaticObjectMethod(cls, mids$[mid_valueOf_1fe189246c742b8a], a0.this$, a1));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass String::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_3b7a1d3d26162b85] = env->getMethodID(cls, "<init>", "()V");
        mids$[mid_init$_e3f6d981bb98002b] = env->getMethodID(cls, "<init>", "(Ljava/lang/StringBuilder;)V");
        mids$[mid_init$_e9f9ecbb9bb29bce] = env->getMethodID(cls, "<init>", "(Ljava/lang/StringBuffer;)V");
        mids$[mid_init$_0aa635e49c766730] = env->getMethodID(cls, "<init>", "([B)V");
        mids$[mid_init$_ee30b01cc5d9d615] = env->getMethodID(cls, "<init>", "([C)V");
        mids$[mid_init$_8cbfd868bfdff135] = env->getMethodID(cls, "<init>", "([BLjava/lang/String;)V");
        mids$[mid_init$_a4aa77e2acc83203] = env->getMethodID(cls, "<init>", "([BI)V");
        mids$[mid_init$_881b8ae3c0bdb376] = env->getMethodID(cls, "<init>", "([BII)V");
        mids$[mid_init$_984e72d4375fd50f] = env->getMethodID(cls, "<init>", "([III)V");
        mids$[mid_init$_7b7b455231dae263] = env->getMethodID(cls, "<init>", "([CII)V");
        mids$[mid_init$_1e123a7bfc92a801] = env->getMethodID(cls, "<init>", "([BIILjava/lang/String;)V");
        mids$[mid_init$_42f870ff4481584e] = env->getMethodID(cls, "<init>", "([BIII)V");
        mids$[mid_charAt_bdde8923c8d84ea7] = env->getMethodID(cls, "charAt", "(I)C");
        mids$[mid_codePointAt_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointAt", "(I)I");
        mids$[mid_codePointBefore_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointBefore", "(I)I");
        mids$[mid_codePointCount_3d7ede988f6b3a33] = env->getMethodID(cls, "codePointCount", "(II)I");
        mids$[mid_compareTo_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "compareTo", "(Ljava/lang/String;)I");
        mids$[mid_compareToIgnoreCase_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "compareToIgnoreCase", "(Ljava/lang/String;)I");
        mids$[mid_concat_c79c18cd95453b7f] = env->getMethodID(cls, "concat", "(Ljava/lang/String;)Ljava/lang/String;");
        mids$[mid_contains_a093ae255199407d] = env->getMethodID(cls, "contains", "(Ljava/lang/CharSequence;)Z");
        mids$[mid_contentEquals_9bacd0c2c4bd71ea] = env->getMethodID(cls, "contentEquals", "(Ljava/lang/StringBuffer;)Z");
        mids$[mid_contentEquals_a093ae255199407d] = env->getMethodID(cls, "contentEquals", "(Ljava/lang/CharSequence;)Z");
        mids$[mid_copyValueOf_ad859f3cfef72b92] = env->getStaticMethodID(cls, "copyValueOf", "([C)Ljava/lang/String;");
        mids$[mid_copyValueOf_cc12409b36f61dbe] = env->getStaticMethodID(cls, "copyValueOf", "([CII)Ljava/lang/String;");
        mids$[mid_endsWith_1dfa664233a47103] = env->getMethodID(cls, "endsWith", "(Ljava/lang/String;)Z");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_equalsIgnoreCase_1dfa664233a47103] = env->getMethodID(cls, "equalsIgnoreCase", "(Ljava/lang/String;)Z");
        mids$[mid_format_e98520bddae6a520] = env->getStaticMethodID(cls, "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;");
        mids$[mid_getBytes_b06da5bfeb7ad4b6] = env->getMethodID(cls, "getBytes", "()[B");
        mids$[mid_getBytes_625b99a7c088ddaf] = env->getMethodID(cls, "getBytes", "(Ljava/lang/String;)[B");
        mids$[mid_getBytes_8b283c8087c7fed3] = env->getMethodID(cls, "getBytes", "(II[BI)V");
        mids$[mid_getChars_b97bea56ebef93e7] = env->getMethodID(cls, "getChars", "(II[CI)V");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_indexOf_4b23a339ec27bbb3] = env->getMethodID(cls, "indexOf", "(I)I");
        mids$[mid_indexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;)I");
        mids$[mid_indexOf_e65105c140eb7151] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;I)I");
        mids$[mid_indexOf_3d7ede988f6b3a33] = env->getMethodID(cls, "indexOf", "(II)I");
        mids$[mid_intern_c041e21e63165d2d] = env->getMethodID(cls, "intern", "()Ljava/lang/String;");
        mids$[mid_isEmpty_318f7cae9d6a33e6] = env->getMethodID(cls, "isEmpty", "()Z");
        mids$[mid_join_dd88d98cf93c3794] = env->getStaticMethodID(cls, "join", "(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Ljava/lang/String;");
        mids$[mid_join_55db8d22d92036d6] = env->getStaticMethodID(cls, "join", "(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;");
        mids$[mid_lastIndexOf_4b23a339ec27bbb3] = env->getMethodID(cls, "lastIndexOf", "(I)I");
        mids$[mid_lastIndexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;)I");
        mids$[mid_lastIndexOf_3d7ede988f6b3a33] = env->getMethodID(cls, "lastIndexOf", "(II)I");
        mids$[mid_lastIndexOf_e65105c140eb7151] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;I)I");
        mids$[mid_length_60df5a771df5b62d] = env->getMethodID(cls, "length", "()I");
        mids$[mid_matches_1dfa664233a47103] = env->getMethodID(cls, "matches", "(Ljava/lang/String;)Z");
        mids$[mid_offsetByCodePoints_3d7ede988f6b3a33] = env->getMethodID(cls, "offsetByCodePoints", "(II)I");
        mids$[mid_regionMatches_b3496c6a4004b75a] = env->getMethodID(cls, "regionMatches", "(ILjava/lang/String;II)Z");
        mids$[mid_regionMatches_bb9b26b6d1e5dc56] = env->getMethodID(cls, "regionMatches", "(ZILjava/lang/String;II)Z");
        mids$[mid_replace_d059205c579400c9] = env->getMethodID(cls, "replace", "(CC)Ljava/lang/String;");
        mids$[mid_replace_3d105a3ff9bb821d] = env->getMethodID(cls, "replace", "(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;");
        mids$[mid_replaceAll_4d5d4b421f989dfc] = env->getMethodID(cls, "replaceAll", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");
        mids$[mid_replaceFirst_4d5d4b421f989dfc] = env->getMethodID(cls, "replaceFirst", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");
        mids$[mid_split_9d1093a8564b26d8] = env->getMethodID(cls, "split", "(Ljava/lang/String;)[Ljava/lang/String;");
        mids$[mid_split_8f69e25c6c689b02] = env->getMethodID(cls, "split", "(Ljava/lang/String;I)[Ljava/lang/String;");
        mids$[mid_startsWith_1dfa664233a47103] = env->getMethodID(cls, "startsWith", "(Ljava/lang/String;)Z");
        mids$[mid_startsWith_5f2909f6abb49638] = env->getMethodID(cls, "startsWith", "(Ljava/lang/String;I)Z");
        mids$[mid_subSequence_4648df63ce82f704] = env->getMethodID(cls, "subSequence", "(II)Ljava/lang/CharSequence;");
        mids$[mid_substring_ab09aaf2e63107e3] = env->getMethodID(cls, "substring", "(I)Ljava/lang/String;");
        mids$[mid_substring_5b238f74b18cd9ba] = env->getMethodID(cls, "substring", "(II)Ljava/lang/String;");
        mids$[mid_toCharArray_c6f65d298757269e] = env->getMethodID(cls, "toCharArray", "()[C");
        mids$[mid_toLowerCase_c041e21e63165d2d] = env->getMethodID(cls, "toLowerCase", "()Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_toUpperCase_c041e21e63165d2d] = env->getMethodID(cls, "toUpperCase", "()Ljava/lang/String;");
        mids$[mid_trim_c041e21e63165d2d] = env->getMethodID(cls, "trim", "()Ljava/lang/String;");
        mids$[mid_valueOf_82ceb9edccd24fa3] = env->getStaticMethodID(cls, "valueOf", "(C)Ljava/lang/String;");
        mids$[mid_valueOf_6b4670e37be63f0c] = env->getStaticMethodID(cls, "valueOf", "(Ljava/lang/Object;)Ljava/lang/String;");
        mids$[mid_valueOf_ea6d2a082bd69826] = env->getStaticMethodID(cls, "valueOf", "(Z)Ljava/lang/String;");
        mids$[mid_valueOf_ad859f3cfef72b92] = env->getStaticMethodID(cls, "valueOf", "([C)Ljava/lang/String;");
        mids$[mid_valueOf_7d2d6127fa523a6f] = env->getStaticMethodID(cls, "valueOf", "(D)Ljava/lang/String;");
        mids$[mid_valueOf_3ef4f0a5c27c2560] = env->getStaticMethodID(cls, "valueOf", "(F)Ljava/lang/String;");
        mids$[mid_valueOf_6cc2f594436f7b3d] = env->getStaticMethodID(cls, "valueOf", "(J)Ljava/lang/String;");
        mids$[mid_valueOf_ab09aaf2e63107e3] = env->getStaticMethodID(cls, "valueOf", "(I)Ljava/lang/String;");
        mids$[mid_valueOf_cc12409b36f61dbe] = env->getStaticMethodID(cls, "valueOf", "([CII)Ljava/lang/String;");
    ...
    String::String() : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    String::String(const ::java::lang::StringBuilder & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_e3f6d981bb98002b, a0.this$)) {}

    String::String(const ::java::lang::StringBuffer & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_e9f9ecbb9bb29bce, a0.this$)) {}

    String::String(const JArray< jbyte > & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_0aa635e49c766730, a0.this$)) {}

    String::String(const JArray< jchar > & a0) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_ee30b01cc5d9d615, a0.this$)) {}

    String::String(const JArray< jbyte > & a0, const String & a1) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_8cbfd868bfdff135, a0.this$, a1.this$)) {}

    String::String(const JArray< jbyte > & a0, jint a1) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_a4aa77e2acc83203, a0.this$, a1)) {}

    String::String(const JArray< jbyte > & a0, jint a1, jint a2) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_881b8ae3c0bdb376, a0.this$, a1, a2)) {}

    String::String(const JArray< jint > & a0, jint a1, jint a2) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_984e72d4375fd50f, a0.this$, a1, a2)) {}

    String::String(const JArray< jchar > & a0, jint a1, jint a2) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_7b7b455231dae263, a0.this$, a1, a2)) {}

    String::String(const JArray< jbyte > & a0, jint a1, jint a2, const String & a3) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_1e123a7bfc92a801, a0.this$, a1, a2, a3.this$)) {}

    String::String(const JArray< jbyte > & a0, jint a1, jint a2, jint a3) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_42f870ff4481584e, a0.this$, a1, a2, a3)) {}

    jchar String::charAt(jint a0) const
    {
      return env->callCharMethod(this$, mids$[mid_charAt_bdde8923c8d84ea7], a0);
    }

    jint String::codePointAt(jint a0) const
    {
      return env->callIntMethod(this$, mids$[mid_codePointAt_4b23a339ec27bbb3], a0);
    }

    jint String::codePointBefore(jint a0) const
    {
      return env->callIntMethod(this$, mids$[mid_codePointBefore_4b23a339ec27bbb3], a0);
    }

    jint String::codePointCount(jint a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_codePointCount_3d7ede988f6b3a33], a0, a1);
    }

    jint String::compareTo(const String & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_9a1fdcf5cfdf78dc], a0.this$);
    }

    jint String::compareToIgnoreCase(const String & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_compareToIgnoreCase_9a1fdcf5cfdf78dc], a0.this$);
    }

    String String::concat(const String & a0) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_concat_c79c18cd95453b7f], a0.this$));
    }

    jboolean String::contains(const ::java::lang::CharSequence & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_contains_a093ae255199407d], a0.this$);
    }

    jboolean String::contentEquals(const ::java::lang::StringBuffer & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_contentEquals_9bacd0c2c4bd71ea], a0.this$);
    }

    jboolean String::contentEquals(const ::java::lang::CharSequence & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_contentEquals_a093ae255199407d], a0.this$);
    }

    String String::copyValueOf(const JArray< jchar > & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_copyValueOf_ad859f3cfef72b92], a0.this$));
    }

    String String::copyValueOf(const JArray< jchar > & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_copyValueOf_cc12409b36f61dbe], a0.this$, a1, a2));
    }

    jboolean String::endsWith(const String & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_endsWith_1dfa664233a47103], a0.this$);
    }
    ...
    {
      return env->callBooleanMethod(this$, mids$[mid_equalsIgnoreCase_1dfa664233a47103], a0.this$);
    }

    String String::format(const String & a0, const JArray< ::java::lang::Object > & a1)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_format_e98520bddae6a520], a0.this$, a1.this$));
    }

    JArray< jbyte > String::getBytes() const
    {
      return JArray< jbyte >(env->callObjectMethod(this$, mids$[mid_getBytes_b06da5bfeb7ad4b6]));
    }

    JArray< jbyte > String::getBytes(const String & a0) const
    {
      return JArray< jbyte >(env->callObjectMethod(this$, mids$[mid_getBytes_625b99a7c088ddaf], a0.this$));
    }

    void String::getBytes(jint a0, jint a1, const JArray< jbyte > & a2, jint a3) const
    {
      env->callVoidMethod(this$, mids$[mid_getBytes_8b283c8087c7fed3], a0, a1, a2.this$, a3);
    }

    void String::getChars(jint a0, jint a1, const JArray< jchar > & a2, jint a3) const
    {
      env->callVoidMethod(this$, mids$[mid_getChars_b97bea56ebef93e7], a0, a1, a2.this$, a3);
    }
    ...
    {
      return env->callIntMethod(this$, mids$[mid_indexOf_4b23a339ec27bbb3], a0);
    }

    jint String::indexOf(const String & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_indexOf_9a1fdcf5cfdf78dc], a0.this$);
    }

    jint String::indexOf(const String & a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_indexOf_e65105c140eb7151], a0.this$, a1);
    }

    jint String::indexOf(jint a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_indexOf_3d7ede988f6b3a33], a0, a1);
    }

    String String::intern() const
    {
      return String(env->callObjectMethod(this$, mids$[mid_intern_c041e21e63165d2d]));
    }

    jboolean String::isEmpty() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isEmpty_318f7cae9d6a33e6]);
    }

    String String::join(const ::java::lang::CharSequence & a0, const JArray< ::java::lang::CharSequence > & a1)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_join_dd88d98cf93c3794], a0.this$, a1.this$));
    }

    String String::join(const ::java::lang::CharSequence & a0, const ::java::lang::Iterable & a1)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_join_55db8d22d92036d6], a0.this$, a1.this$));
    }

    jint String::lastIndexOf(jint a0) const
    {
      return env->callIntMethod(this$, mids$[mid_lastIndexOf_4b23a339ec27bbb3], a0);
    }

    jint String::lastIndexOf(const String & a0) const
    {
      return env->callIntMethod(this$, mids$[mid_lastIndexOf_9a1fdcf5cfdf78dc], a0.this$);
    }

    jint String::lastIndexOf(jint a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_lastIndexOf_3d7ede988f6b3a33], a0, a1);
    }

    jint String::lastIndexOf(const String & a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_lastIndexOf_e65105c140eb7151], a0.this$, a1);
    }

    jint String::length() const
    {
      return env->callIntMethod(this$, mids$[mid_length_60df5a771df5b62d]);
    }

    jboolean String::matches(const String & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_matches_1dfa664233a47103], a0.this$);
    }

    jint String::offsetByCodePoints(jint a0, jint a1) const
    {
      return env->callIntMethod(this$, mids$[mid_offsetByCodePoints_3d7ede988f6b3a33], a0, a1);
    }

    jboolean String::regionMatches(jint a0, const String & a1, jint a2, jint a3) const
    {
      return env->callBooleanMethod(this$, mids$[mid_regionMatches_b3496c6a4004b75a], a0, a1.this$, a2, a3);
    }

    jboolean String::regionMatches(jboolean a0, jint a1, const String & a2, jint a3, jint a4) const
    {
      return env->callBooleanMethod(this$, mids$[mid_regionMatches_bb9b26b6d1e5dc56], a0, a1, a2.this$, a3, a4);
    }

    String String::replace(jchar a0, jchar a1) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_replace_d059205c579400c9], a0, a1));
    }

    String String::replace(const ::java::lang::CharSequence & a0, const ::java::lang::CharSequence & a1) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_replace_3d105a3ff9bb821d], a0.this$, a1.this$));
    }

    String String::replaceAll(const String & a0, const String & a1) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_replaceAll_4d5d4b421f989dfc], a0.this$, a1.this$));
    }

    String String::replaceFirst(const String & a0, const String & a1) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_replaceFirst_4d5d4b421f989dfc], a0.this$, a1.this$));
    }

    JArray< String > String::split(const String & a0) const
    {
      return JArray< String >(env->callObjectMethod(this$, mids$[mid_split_9d1093a8564b26d8], a0.this$));
    }

    JArray< String > String::split(const String & a0, jint a1) const
    {
      return JArray< String >(env->callObjectMethod(this$, mids$[mid_split_8f69e25c6c689b02], a0.this$, a1));
    }

    jboolean String::startsWith(const String & a0) const
    {
      return env->callBooleanMethod(this$, mids$[mid_startsWith_1dfa664233a47103], a0.this$);
    }

    jboolean String::startsWith(const String & a0, jint a1) const
    {
      return env->callBooleanMethod(this$, mids$[mid_startsWith_5f2909f6abb49638], a0.this$, a1);
    }

    ::java::lang::CharSequence String::subSequence(jint a0, jint a1) const
    {
      return ::java::lang::CharSequence(env->callObjectMethod(this$, mids$[mid_subSequence_4648df63ce82f704], a0, a1));
    }

    String String::substring(jint a0) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_substring_ab09aaf2e63107e3], a0));
    }

    String String::substring(jint a0, jint a1) const
    {
      return String(env->callObjectMethod(this$, mids$[mid_substring_5b238f74b18cd9ba], a0, a1));
    }

    JArray< jchar > String::toCharArray() const
    {
      return JArray< jchar >(env->callObjectMethod(this$, mids$[mid_toCharArray_c6f65d298757269e]));
    }

    String String::toLowerCase() const
    {
      return String(env->callObjectMethod(this$, mids$[mid_toLowerCase_c041e21e63165d2d]));
    }

    String String::toString() const
    {
      return String(env->callObjectMethod(this$, mids$[mid_toString_c041e21e63165d2d]));
    }

    String String::toUpperCase() const
    {
      return String(env->callObjectMethod(this$, mids$[mid_toUpperCase_c041e21e63165d2d]));
    }

    String String::trim() const
    {
      return String(env->callObjectMethod(this$, mids$[mid_trim_c041e21e63165d2d]));
    }

    String String::valueOf(jchar a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_82ceb9edccd24fa3], a0));
    }

    String String::valueOf(const ::java::lang::Object & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_6b4670e37be63f0c], a0.this$));
    }

    String String::valueOf(jboolean a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_ea6d2a082bd69826], a0));
    }

    String String::valueOf(const JArray< jchar > & a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_ad859f3cfef72b92], a0.this$));
    }

    String String::valueOf(jdouble a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_7d2d6127fa523a6f], a0));
    }

    String String::valueOf(jfloat a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_3ef4f0a5c27c2560], a0));
    }

    String String::valueOf(jlong a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_6cc2f594436f7b3d], a0));
    }

    String String::valueOf(jint a0)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_ab09aaf2e63107e3], a0));
    }

    String String::valueOf(const JArray< jchar > & a0, jint a1, jint a2)
    {
      jclass cls = env->getClass(initializeClass);
      return String(env->callStaticObjectMethod(cls, mids$[mid_valueOf_cc12409b36f61dbe], a0.this$, a1, a2));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass StackTraceElement::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_1a58a3c5e13d2312] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V");
        mids$[mid_equals_04e1a7382c29bc4b] = env->getMethodID(cls, "equals", "(Ljava/lang/Object;)Z");
        mids$[mid_getClassName_c041e21e63165d2d] = env->getMethodID(cls, "getClassName", "()Ljava/lang/String;");
        mids$[mid_getFileName_c041e21e63165d2d] = env->getMethodID(cls, "getFileName", "()Ljava/lang/String;");
        mids$[mid_getLineNumber_60df5a771df5b62d] = env->getMethodID(cls, "getLineNumber", "()I");
        mids$[mid_getMethodName_c041e21e63165d2d] = env->getMethodID(cls, "getMethodName", "()Ljava/lang/String;");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_isNativeMethod_318f7cae9d6a33e6] = env->getMethodID(cls, "isNativeMethod", "()Z");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
    ...
    StackTraceElement::StackTraceElement(const ::java::lang::String & a0, const ::java::lang::String & a1, const ::java::lang::String & a2, jint a3) : ::java::lang::Object(env->newObject(initializeClass, &mids$, mid_init$_1a58a3c5e13d2312, a0.this$, a1.this$, a2.this$, a3)) {}
    ...
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getClassName_c041e21e63165d2d]));
    }

    ::java::lang::String StackTraceElement::getFileName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getFileName_c041e21e63165d2d]));
    }

    jint StackTraceElement::getLineNumber() const
    {
      return env->callIntMethod(this$, mids$[mid_getLineNumber_60df5a771df5b62d]);
    }

    ::java::lang::String StackTraceElement::getMethodName() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getMethodName_c041e21e63165d2d]));
    }
    ...
    {
      return env->callBooleanMethod(this$, mids$[mid_isNativeMethod_318f7cae9d6a33e6]);
    }
  ...
  namespace lang {
    ...
    jclass Iterable::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_iterator_127cb3a7206b03da] = env->getMethodID(cls, "iterator", "()Ljava/util/Iterator;");
    ...
    {
      return ::java::util::Iterator(env->callObjectMethod(this$, mids$[mid_iterator_127cb3a7206b03da]));
    }
  }
}
  ...
  namespace lang {
    ...
    jclass StringBuilder::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_init$_3b7a1d3d26162b85] = env->getMethodID(cls, "<init>", "()V");
        mids$[mid_init$_ff3cc5064b2f599b] = env->getMethodID(cls, "<init>", "(Ljava/lang/CharSequence;)V");
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_a9395152fa63d3b0] = env->getMethodID(cls, "<init>", "(I)V");
        mids$[mid_append_af7d2abbcfd14857] = env->getMethodID(cls, "append", "(Z)Ljava/lang/StringBuilder;");
        mids$[mid_append_615db9cc8130353e] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/lang/StringBuilder;");
        mids$[mid_append_5b23a8244b9a7150] = env->getMethodID(cls, "append", "(C)Ljava/lang/StringBuilder;");
        mids$[mid_append_ebe660f89dd63af9] = env->getMethodID(cls, "append", "(I)Ljava/lang/StringBuilder;");
        mids$[mid_append_2c67186a89fb716a] = env->getMethodID(cls, "append", "(Ljava/lang/StringBuffer;)Ljava/lang/StringBuilder;");
        mids$[mid_append_50bc4c45d6d1ccb0] = env->getMethodID(cls, "append", "([C)Ljava/lang/StringBuilder;");
        mids$[mid_append_7c57ac4532fb10c6] = env->getMethodID(cls, "append", "(D)Ljava/lang/StringBuilder;");
        mids$[mid_append_b1969b95267bc710] = env->getMethodID(cls, "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
        mids$[mid_append_abe9c630a6bcec9a] = env->getMethodID(cls, "append", "(Ljava/lang/Object;)Ljava/lang/StringBuilder;");
        mids$[mid_append_75d8ec5fd89b4c81] = env->getMethodID(cls, "append", "(J)Ljava/lang/StringBuilder;");
        mids$[mid_append_9808c39286a58fb4] = env->getMethodID(cls, "append", "(F)Ljava/lang/StringBuilder;");
        mids$[mid_append_86a23dc66ce8be4e] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;");
        mids$[mid_append_1be669dbfa8a5f42] = env->getMethodID(cls, "append", "([CII)Ljava/lang/StringBuilder;");
        mids$[mid_appendCodePoint_ebe660f89dd63af9] = env->getMethodID(cls, "appendCodePoint", "(I)Ljava/lang/StringBuilder;");
        mids$[mid_delete_ad6c2ebf815e7874] = env->getMethodID(cls, "delete", "(II)Ljava/lang/StringBuilder;");
        mids$[mid_deleteCharAt_ebe660f89dd63af9] = env->getMethodID(cls, "deleteCharAt", "(I)Ljava/lang/StringBuilder;");
        mids$[mid_indexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;)I");
        mids$[mid_indexOf_e65105c140eb7151] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;I)I");
        mids$[mid_insert_41aa9b40506a0c7c] = env->getMethodID(cls, "insert", "(ID)Ljava/lang/StringBuilder;");
        mids$[mid_insert_c9d73301c404c2b1] = env->getMethodID(cls, "insert", "(IF)Ljava/lang/StringBuilder;");
        mids$[mid_insert_8dbeeea672a0f6a0] = env->getMethodID(cls, "insert", "(IJ)Ljava/lang/StringBuilder;");
        mids$[mid_insert_ad6c2ebf815e7874] = env->getMethodID(cls, "insert", "(II)Ljava/lang/StringBuilder;");
        mids$[mid_insert_2c7cf152a89adacc] = env->getMethodID(cls, "insert", "(ILjava/lang/Object;)Ljava/lang/StringBuilder;");
        mids$[mid_insert_f7f2e629629f9764] = env->getMethodID(cls, "insert", "(ILjava/lang/String;)Ljava/lang/StringBuilder;");
        mids$[mid_insert_fd15656206a5851f] = env->getMethodID(cls, "insert", "(I[C)Ljava/lang/StringBuilder;");
        mids$[mid_insert_b889c6353701bffb] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;)Ljava/lang/StringBuilder;");
        mids$[mid_insert_c15637c39fa9b9d0] = env->getMethodID(cls, "insert", "(IZ)Ljava/lang/StringBuilder;");
        mids$[mid_insert_5a00b5ac4d30082a] = env->getMethodID(cls, "insert", "(IC)Ljava/lang/StringBuilder;");
        mids$[mid_insert_cf2bb79cf264d07b] = env->getMethodID(cls, "insert", "(I[CII)Ljava/lang/StringBuilder;");
        mids$[mid_insert_168eaacd337739a9] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;II)Ljava/lang/StringBuilder;");
        mids$[mid_lastIndexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;)I");
        mids$[mid_lastIndexOf_e65105c140eb7151] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;I)I");
        mids$[mid_replace_dd655b1c75d33bab] = env->getMethodID(cls, "replace", "(IILjava/lang/String;)Ljava/lang/StringBuilder;");
        mids$[mid_reverse_f0c340607bb6e2bc] = env->getMethodID(cls, "reverse", "()Ljava/lang/StringBuilder;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
    ...
    StringBuilder::StringBuilder() : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    StringBuilder::StringBuilder(const ::java::lang::CharSequence & a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_ff3cc5064b2f599b, a0.this$)) {}

    StringBuilder::StringBuilder(const ::java::lang::String & a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    StringBuilder::StringBuilder(jint a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_a9395152fa63d3b0, a0)) {}

    StringBuilder StringBuilder::append(jboolean a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_af7d2abbcfd14857], a0));
    }

    StringBuilder StringBuilder::append(const ::java::lang::CharSequence & a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_615db9cc8130353e], a0.this$));
    }

    StringBuilder StringBuilder::append(jchar a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_5b23a8244b9a7150], a0));
    }

    StringBuilder StringBuilder::append(jint a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_ebe660f89dd63af9], a0));
    }

    StringBuilder StringBuilder::append(const ::java::lang::StringBuffer & a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_2c67186a89fb716a], a0.this$));
    }

    StringBuilder StringBuilder::append(const JArray< jchar > & a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_50bc4c45d6d1ccb0], a0.this$));
    }

    StringBuilder StringBuilder::append(jdouble a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_7c57ac4532fb10c6], a0));
    }

    StringBuilder StringBuilder::append(const ::java::lang::String & a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_b1969b95267bc710], a0.this$));
    }

    StringBuilder StringBuilder::append(const ::java::lang::Object & a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_abe9c630a6bcec9a], a0.this$));
    }

    StringBuilder StringBuilder::append(jlong a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_75d8ec5fd89b4c81], a0));
    }

    StringBuilder StringBuilder::append(jfloat a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_9808c39286a58fb4], a0));
    }

    StringBuilder StringBuilder::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_86a23dc66ce8be4e], a0.this$, a1, a2));
    }

    StringBuilder StringBuilder::append(const JArray< jchar > & a0, jint a1, jint a2) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_append_1be669dbfa8a5f42], a0.this$, a1, a2));
    }

    StringBuilder StringBuilder::appendCodePoint(jint a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_appendCodePoint_ebe660f89dd63af9], a0));
    }

    StringBuilder StringBuilder::delete$(jint a0, jint a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_delete_ad6c2ebf815e7874], a0, a1));
    }

    StringBuilder StringBuilder::deleteCharAt(jint a0) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_deleteCharAt_ebe660f89dd63af9], a0));
    }
    ...
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_41aa9b40506a0c7c], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, jfloat a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_c9d73301c404c2b1], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, jlong a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_8dbeeea672a0f6a0], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, jint a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_ad6c2ebf815e7874], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, const ::java::lang::Object & a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_2c7cf152a89adacc], a0, a1.this$));
    }

    StringBuilder StringBuilder::insert(jint a0, const ::java::lang::String & a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_f7f2e629629f9764], a0, a1.this$));
    }

    StringBuilder StringBuilder::insert(jint a0, const JArray< jchar > & a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_fd15656206a5851f], a0, a1.this$));
    }

    StringBuilder StringBuilder::insert(jint a0, const ::java::lang::CharSequence & a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_b889c6353701bffb], a0, a1.this$));
    }

    StringBuilder StringBuilder::insert(jint a0, jboolean a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_c15637c39fa9b9d0], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, jchar a1) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_5a00b5ac4d30082a], a0, a1));
    }

    StringBuilder StringBuilder::insert(jint a0, const JArray< jchar > & a1, jint a2, jint a3) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_cf2bb79cf264d07b], a0, a1.this$, a2, a3));
    }

    StringBuilder StringBuilder::insert(jint a0, const ::java::lang::CharSequence & a1, jint a2, jint a3) const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_insert_168eaacd337739a9], a0, a1.this$, a2, a3));
    }
    ...
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_replace_dd655b1c75d33bab], a0, a1, a2.this$));
    }

    StringBuilder StringBuilder::reverse() const
    {
      return StringBuilder(env->callObjectMethod(this$, mids$[mid_reverse_f0c340607bb6e2bc]));
    }
...
namespace java {
  namespace lang {
    ...
    InterruptedException::InterruptedException() : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    InterruptedException::InterruptedException(const ::java::lang::String & a0) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
  }
}
...
namespace java {
  namespace lang {
    ...
    IllegalArgumentException::IllegalArgumentException() : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    IllegalArgumentException::IllegalArgumentException(const ::java::lang::Throwable & a0) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_359aa6a1d41f0219, a0.this$)) {}

    IllegalArgumentException::IllegalArgumentException(const ::java::lang::String & a0) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    IllegalArgumentException::IllegalArgumentException(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}
  }
}
  ...
  namespace lang {
    ...
    jclass StringBuffer::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_38d57a80b9fe8948] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;)V");
        mids$[mid_init$_a9395152fa63d3b0] = env->getMethodID(cls, "<init>", "(I)V");
        mids$[mid_append_426fe3ac3d43fefd] = env->getMethodID(cls, "append", "(F)Ljava/lang/StringBuffer;");
        mids$[mid_append_aa2576eef5131e53] = env->getMethodID(cls, "append", "(D)Ljava/lang/StringBuffer;");
        mids$[mid_append_b3ba0fb122eacf19] = env->getMethodID(cls, "append", "(Z)Ljava/lang/StringBuffer;");
        mids$[mid_append_cda9f7b6e05b0a02] = env->getMethodID(cls, "append", "(C)Ljava/lang/StringBuffer;");
        mids$[mid_append_c0c0c37c99d83c09] = env->getMethodID(cls, "append", "(I)Ljava/lang/StringBuffer;");
        mids$[mid_append_8025af948a3e9186] = env->getMethodID(cls, "append", "(J)Ljava/lang/StringBuffer;");
        mids$[mid_append_181a75ed6a0cb1a5] = env->getMethodID(cls, "append", "(Ljava/lang/Object;)Ljava/lang/StringBuffer;");
        mids$[mid_append_cef988fbfb7d16a4] = env->getMethodID(cls, "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;");
        mids$[mid_append_84366649671152ba] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/lang/StringBuffer;");
        mids$[mid_append_084bd2e5156b3c9a] = env->getMethodID(cls, "append", "([C)Ljava/lang/StringBuffer;");
        mids$[mid_append_f43568b491d883af] = env->getMethodID(cls, "append", "(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;");
        mids$[mid_append_f41dc9a4b5104906] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/lang/StringBuffer;");
        mids$[mid_append_6a37fabe21bcb893] = env->getMethodID(cls, "append", "([CII)Ljava/lang/StringBuffer;");
        mids$[mid_appendCodePoint_c0c0c37c99d83c09] = env->getMethodID(cls, "appendCodePoint", "(I)Ljava/lang/StringBuffer;");
        mids$[mid_capacity_60df5a771df5b62d] = env->getMethodID(cls, "capacity", "()I");
        mids$[mid_charAt_bdde8923c8d84ea7] = env->getMethodID(cls, "charAt", "(I)C");
        mids$[mid_codePointAt_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointAt", "(I)I");
        mids$[mid_codePointBefore_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointBefore", "(I)I");
        mids$[mid_codePointCount_3d7ede988f6b3a33] = env->getMethodID(cls, "codePointCount", "(II)I");
        mids$[mid_delete_5dd1facc587387ac] = env->getMethodID(cls, "delete", "(II)Ljava/lang/StringBuffer;");
        mids$[mid_deleteCharAt_c0c0c37c99d83c09] = env->getMethodID(cls, "deleteCharAt", "(I)Ljava/lang/StringBuffer;");
        mids$[mid_ensureCapacity_a9395152fa63d3b0] = env->getMethodID(cls, "ensureCapacity", "(I)V");
        mids$[mid_getChars_b97bea56ebef93e7] = env->getMethodID(cls, "getChars", "(II[CI)V");
        mids$[mid_indexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;)I");
        mids$[mid_indexOf_e65105c140eb7151] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;I)I");
        mids$[mid_insert_6602b02ad4c6a3e5] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;)Ljava/lang/StringBuffer;");
        mids$[mid_insert_78be8a5a60a02951] = env->getMethodID(cls, "insert", "(IZ)Ljava/lang/StringBuffer;");
        mids$[mid_insert_625b052e59a9dc3e] = env->getMethodID(cls, "insert", "(IC)Ljava/lang/StringBuffer;");
        mids$[mid_insert_5dd1facc587387ac] = env->getMethodID(cls, "insert", "(II)Ljava/lang/StringBuffer;");
        mids$[mid_insert_5675c2755801fc25] = env->getMethodID(cls, "insert", "(IF)Ljava/lang/StringBuffer;");
        mids$[mid_insert_621bb4167a4cb605] = env->getMethodID(cls, "insert", "(ID)Ljava/lang/StringBuffer;");
        mids$[mid_insert_cf80aec281352ebd] = env->getMethodID(cls, "insert", "(ILjava/lang/Object;)Ljava/lang/StringBuffer;");
        mids$[mid_insert_094f54d4358441b9] = env->getMethodID(cls, "insert", "(ILjava/lang/String;)Ljava/lang/StringBuffer;");
        mids$[mid_insert_ea8e8c239f7e298c] = env->getMethodID(cls, "insert", "(I[C)Ljava/lang/StringBuffer;");
        mids$[mid_insert_ac442ed20685c94e] = env->getMethodID(cls, "insert", "(IJ)Ljava/lang/StringBuffer;");
        mids$[mid_insert_a62abaf3a51008fb] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;II)Ljava/lang/StringBuffer;");
        mids$[mid_insert_1794229cb2a1f03c] = env->getMethodID(cls, "insert", "(I[CII)Ljava/lang/StringBuffer;");
        mids$[mid_lastIndexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;)I");
        mids$[mid_lastIndexOf_e65105c140eb7151] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;I)I");
        mids$[mid_length_60df5a771df5b62d] = env->getMethodID(cls, "length", "()I");
        mids$[mid_offsetByCodePoints_3d7ede988f6b3a33] = env->getMethodID(cls, "offsetByCodePoints", "(II)I");
        mids$[mid_replace_c7f0aec381da8df2] = env->getMethodID(cls, "replace", "(IILjava/lang/String;)Ljava/lang/StringBuffer;");
        mids$[mid_reverse_c9864812d0ad9e24] = env->getMethodID(cls, "reverse", "()Ljava/lang/StringBuffer;");
        mids$[mid_setCharAt_c50c5bdc97f9afe7] = env->getMethodID(cls, "setCharAt", "(IC)V");
        mids$[mid_setLength_a9395152fa63d3b0] = env->getMethodID(cls, "setLength", "(I)V");
        mids$[mid_subSequence_4648df63ce82f704] = env->getMethodID(cls, "subSequence", "(II)Ljava/lang/CharSequence;");
        mids$[mid_substring_ab09aaf2e63107e3] = env->getMethodID(cls, "substring", "(I)Ljava/lang/String;");
        mids$[mid_substring_5b238f74b18cd9ba] = env->getMethodID(cls, "substring", "(II)Ljava/lang/String;");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
        mids$[mid_trimToSize_3b7a1d3d26162b85] = env->getMethodID(cls, "trimToSize", "()V");
    ...
    StringBuffer::StringBuffer() : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    StringBuffer::StringBuffer(const ::java::lang::CharSequence & a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_ff3cc5064b2f599b, a0.this$)) {}

    StringBuffer::StringBuffer(const ::java::lang::String & a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    StringBuffer::StringBuffer(jint a0) : ::java::lang::AbstractStringBuilder(env->newObject(initializeClass, &mids$, mid_init$_a9395152fa63d3b0, a0)) {}

    StringBuffer StringBuffer::append(jfloat a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_426fe3ac3d43fefd], a0));
    }

    StringBuffer StringBuffer::append(jdouble a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_aa2576eef5131e53], a0));
    }

    StringBuffer StringBuffer::append(jboolean a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_b3ba0fb122eacf19], a0));
    }

    StringBuffer StringBuffer::append(jchar a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_cda9f7b6e05b0a02], a0));
    }

    StringBuffer StringBuffer::append(jint a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_c0c0c37c99d83c09], a0));
    }

    StringBuffer StringBuffer::append(jlong a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_8025af948a3e9186], a0));
    }

    StringBuffer StringBuffer::append(const ::java::lang::Object & a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_181a75ed6a0cb1a5], a0.this$));
    }

    StringBuffer StringBuffer::append(const ::java::lang::String & a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_cef988fbfb7d16a4], a0.this$));
    }

    StringBuffer StringBuffer::append(const ::java::lang::CharSequence & a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_84366649671152ba], a0.this$));
    }

    StringBuffer StringBuffer::append(const JArray< jchar > & a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_084bd2e5156b3c9a], a0.this$));
    }

    StringBuffer StringBuffer::append(const StringBuffer & a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_f43568b491d883af], a0.this$));
    }

    StringBuffer StringBuffer::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_f41dc9a4b5104906], a0.this$, a1, a2));
    }

    StringBuffer StringBuffer::append(const JArray< jchar > & a0, jint a1, jint a2) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_append_6a37fabe21bcb893], a0.this$, a1, a2));
    }

    StringBuffer StringBuffer::appendCodePoint(jint a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_appendCodePoint_c0c0c37c99d83c09], a0));
    }

    jint StringBuffer::capacity() const
    {
      return env->callIntMethod(this$, mids$[mid_capacity_60df5a771df5b62d]);
    }
    ...
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_delete_5dd1facc587387ac], a0, a1));
    }

    StringBuffer StringBuffer::deleteCharAt(jint a0) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_deleteCharAt_c0c0c37c99d83c09], a0));
    }

    void StringBuffer::ensureCapacity(jint a0) const
    {
      env->callVoidMethod(this$, mids$[mid_ensureCapacity_a9395152fa63d3b0], a0);
    }
    ...
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_6602b02ad4c6a3e5], a0, a1.this$));
    }

    StringBuffer StringBuffer::insert(jint a0, jboolean a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_78be8a5a60a02951], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, jchar a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_625b052e59a9dc3e], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, jint a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_5dd1facc587387ac], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, jfloat a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_5675c2755801fc25], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, jdouble a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_621bb4167a4cb605], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, const ::java::lang::Object & a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_cf80aec281352ebd], a0, a1.this$));
    }

    StringBuffer StringBuffer::insert(jint a0, const ::java::lang::String & a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_094f54d4358441b9], a0, a1.this$));
    }

    StringBuffer StringBuffer::insert(jint a0, const JArray< jchar > & a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_ea8e8c239f7e298c], a0, a1.this$));
    }

    StringBuffer StringBuffer::insert(jint a0, jlong a1) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_ac442ed20685c94e], a0, a1));
    }

    StringBuffer StringBuffer::insert(jint a0, const ::java::lang::CharSequence & a1, jint a2, jint a3) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_a62abaf3a51008fb], a0, a1.this$, a2, a3));
    }

    StringBuffer StringBuffer::insert(jint a0, const JArray< jchar > & a1, jint a2, jint a3) const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_insert_1794229cb2a1f03c], a0, a1.this$, a2, a3));
    }
    ...
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_replace_c7f0aec381da8df2], a0, a1, a2.this$));
    }

    StringBuffer StringBuffer::reverse() const
    {
      return StringBuffer(env->callObjectMethod(this$, mids$[mid_reverse_c9864812d0ad9e24]));
    }

    void StringBuffer::setCharAt(jint a0, jchar a1) const
    {
      env->callVoidMethod(this$, mids$[mid_setCharAt_c50c5bdc97f9afe7], a0, a1);
    }

    void StringBuffer::setLength(jint a0) const
    {
      env->callVoidMethod(this$, mids$[mid_setLength_a9395152fa63d3b0], a0);
    }
    ...
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_substring_ab09aaf2e63107e3], a0));
    }

    ::java::lang::String StringBuffer::substring(jint a0, jint a1) const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_substring_5b238f74b18cd9ba], a0, a1));
    }
    ...
    {
      env->callVoidMethod(this$, mids$[mid_trimToSize_3b7a1d3d26162b85]);
    }
  }
}
...
namespace java {
  namespace lang {
    ...
    ReflectiveOperationException::ReflectiveOperationException() : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    ReflectiveOperationException::ReflectiveOperationException(const ::java::lang::Throwable & a0) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_359aa6a1d41f0219, a0.this$)) {}

    ReflectiveOperationException::ReflectiveOperationException(const ::java::lang::String & a0) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    ReflectiveOperationException::ReflectiveOperationException(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::Exception(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}
  }
}
  ...
  namespace lang {
    ...
    jclass Comparable::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_compareTo_158021391988ca97] = env->getMethodID(cls, "compareTo", "(Ljava/lang/Object;)I");
    ...
    {
      return env->callIntMethod(this$, mids$[mid_compareTo_158021391988ca97], a0.this$);
    }
  }
}
...
namespace java {
  namespace lang {
    ...
    NumberFormatException::NumberFormatException() : ::java::lang::IllegalArgumentException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    NumberFormatException::NumberFormatException(const ::java::lang::String & a0) : ::java::lang::IllegalArgumentException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
  }
}
  ...
  namespace lang {
    ...
    jclass AbstractStringBuilder::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_append_d8c6a87360a65bfc] = env->getMethodID(cls, "append", "([C)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_3535358b27892d62] = env->getMethodID(cls, "append", "(Z)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_c39d10f63f3e3b62] = env->getMethodID(cls, "append", "(Ljava/lang/StringBuffer;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_11295eaa75f99c15] = env->getMethodID(cls, "append", "(Ljava/lang/String;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_8c4ef90d99427fa9] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_ba88eeceb9040dae] = env->getMethodID(cls, "append", "(D)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_9d36cc6d15ce04f0] = env->getMethodID(cls, "append", "(C)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_be91bf664544116b] = env->getMethodID(cls, "append", "(I)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_aff8b5c83ebbc663] = env->getMethodID(cls, "append", "(J)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_9611f403986e6b32] = env->getMethodID(cls, "append", "(F)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_8cc3a988492857d1] = env->getMethodID(cls, "append", "(Ljava/lang/Object;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_d80ca156c78b55a7] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_append_a705bf52c0fbc8a9] = env->getMethodID(cls, "append", "([CII)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_appendCodePoint_be91bf664544116b] = env->getMethodID(cls, "appendCodePoint", "(I)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_capacity_60df5a771df5b62d] = env->getMethodID(cls, "capacity", "()I");
        mids$[mid_charAt_bdde8923c8d84ea7] = env->getMethodID(cls, "charAt", "(I)C");
        mids$[mid_codePointAt_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointAt", "(I)I");
        mids$[mid_codePointBefore_4b23a339ec27bbb3] = env->getMethodID(cls, "codePointBefore", "(I)I");
        mids$[mid_codePointCount_3d7ede988f6b3a33] = env->getMethodID(cls, "codePointCount", "(II)I");
        mids$[mid_delete_7abcb35126e9515b] = env->getMethodID(cls, "delete", "(II)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_deleteCharAt_be91bf664544116b] = env->getMethodID(cls, "deleteCharAt", "(I)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_ensureCapacity_a9395152fa63d3b0] = env->getMethodID(cls, "ensureCapacity", "(I)V");
        mids$[mid_getChars_b97bea56ebef93e7] = env->getMethodID(cls, "getChars", "(II[CI)V");
        mids$[mid_indexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;)I");
        mids$[mid_indexOf_e65105c140eb7151] = env->getMethodID(cls, "indexOf", "(Ljava/lang/String;I)I");
        mids$[mid_insert_7abcb35126e9515b] = env->getMethodID(cls, "insert", "(II)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_a3f4844849208606] = env->getMethodID(cls, "insert", "(IC)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_dd5bafc6d81078d1] = env->getMethodID(cls, "insert", "(IZ)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_5013578b27f5e0b8] = env->getMethodID(cls, "insert", "(ILjava/lang/Object;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_98f82040e272d5cc] = env->getMethodID(cls, "insert", "(ID)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_7cc7f81017d8421d] = env->getMethodID(cls, "insert", "(IF)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_26726f0ade29aeba] = env->getMethodID(cls, "insert", "(IJ)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_21dd0287252a0684] = env->getMethodID(cls, "insert", "(ILjava/lang/String;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_659ccb048403f789] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_93a201a10165a632] = env->getMethodID(cls, "insert", "(I[C)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_9441e009188a9ce7] = env->getMethodID(cls, "insert", "(ILjava/lang/CharSequence;II)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_insert_c39c751353502734] = env->getMethodID(cls, "insert", "(I[CII)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_lastIndexOf_9a1fdcf5cfdf78dc] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;)I");
        mids$[mid_lastIndexOf_e65105c140eb7151] = env->getMethodID(cls, "lastIndexOf", "(Ljava/lang/String;I)I");
        mids$[mid_length_60df5a771df5b62d] = env->getMethodID(cls, "length", "()I");
        mids$[mid_offsetByCodePoints_3d7ede988f6b3a33] = env->getMethodID(cls, "offsetByCodePoints", "(II)I");
        mids$[mid_replace_447e18418f6e038d] = env->getMethodID(cls, "replace", "(IILjava/lang/String;)Ljava/lang/AbstractStringBuilder;");
        mids$[mid_reverse_3b0163deb49d372f] = env->getMethodID(cls, "reverse", "()Ljava/lang/AbstractStringBuilder;");
        mids$[mid_setCharAt_c50c5bdc97f9afe7] = env->getMethodID(cls, "setCharAt", "(IC)V");
        mids$[mid_setLength_a9395152fa63d3b0] = env->getMethodID(cls, "setLength", "(I)V");
        mids$[mid_subSequence_4648df63ce82f704] = env->getMethodID(cls, "subSequence", "(II)Ljava/lang/CharSequence;");
        mids$[mid_substring_ab09aaf2e63107e3] = env->getMethodID(cls, "substring", "(I)Ljava/lang/String;");
    ...
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_d8c6a87360a65bfc], a0.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jboolean a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_3535358b27892d62], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const ::java::lang::StringBuffer & a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_c39d10f63f3e3b62], a0.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const ::java::lang::String & a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_11295eaa75f99c15], a0.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const ::java::lang::CharSequence & a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_8c4ef90d99427fa9], a0.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jdouble a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_ba88eeceb9040dae], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jchar a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_9d36cc6d15ce04f0], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jint a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_be91bf664544116b], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jlong a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_aff8b5c83ebbc663], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(jfloat a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_9611f403986e6b32], a0));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const ::java::lang::Object & a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_8cc3a988492857d1], a0.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_d80ca156c78b55a7], a0.this$, a1, a2));
    }

    AbstractStringBuilder AbstractStringBuilder::append(const JArray< jchar > & a0, jint a1, jint a2) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_append_a705bf52c0fbc8a9], a0.this$, a1, a2));
    }

    AbstractStringBuilder AbstractStringBuilder::appendCodePoint(jint a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_appendCodePoint_be91bf664544116b], a0));
    }
    ...
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_delete_7abcb35126e9515b], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::deleteCharAt(jint a0) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_deleteCharAt_be91bf664544116b], a0));
    }
    ...
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_7abcb35126e9515b], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, jchar a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_a3f4844849208606], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, jboolean a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_dd5bafc6d81078d1], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const ::java::lang::Object & a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_5013578b27f5e0b8], a0, a1.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, jdouble a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_98f82040e272d5cc], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, jfloat a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_7cc7f81017d8421d], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, jlong a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_26726f0ade29aeba], a0, a1));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const ::java::lang::String & a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_21dd0287252a0684], a0, a1.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const ::java::lang::CharSequence & a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_659ccb048403f789], a0, a1.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const JArray< jchar > & a1) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_93a201a10165a632], a0, a1.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const ::java::lang::CharSequence & a1, jint a2, jint a3) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_9441e009188a9ce7], a0, a1.this$, a2, a3));
    }

    AbstractStringBuilder AbstractStringBuilder::insert(jint a0, const JArray< jchar > & a1, jint a2, jint a3) const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_insert_c39c751353502734], a0, a1.this$, a2, a3));
    }
    ...
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_replace_447e18418f6e038d], a0, a1, a2.this$));
    }

    AbstractStringBuilder AbstractStringBuilder::reverse() const
    {
      return AbstractStringBuilder(env->callObjectMethod(this$, mids$[mid_reverse_3b0163deb49d372f]));
    }
  ...
  namespace lang {
    ...
    jclass ClassNotFoundException::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$[mid_init$_5df017320dfbf543] = env->getMethodID(cls, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V");
        mids$[mid_getCause_81fe1f12b87f141b] = env->getMethodID(cls, "getCause", "()Ljava/lang/Throwable;");
        mids$[mid_getException_81fe1f12b87f141b] = env->getMethodID(cls, "getException", "()Ljava/lang/Throwable;");
    ...
    ClassNotFoundException::ClassNotFoundException() : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    ClassNotFoundException::ClassNotFoundException(const ::java::lang::String & a0) : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    ClassNotFoundException::ClassNotFoundException(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}

    ::java::lang::Throwable ClassNotFoundException::getCause() const
    {
      return ::java::lang::Throwable(env->callObjectMethod(this$, mids$[mid_getCause_81fe1f12b87f141b]));
    }

    ::java::lang::Throwable ClassNotFoundException::getException() const
    {
      return ::java::lang::Throwable(env->callObjectMethod(this$, mids$[mid_getException_81fe1f12b87f141b]));
    }
  }
}
...
namespace java {
  namespace lang {
    ...
    InstantiationException::InstantiationException() : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    InstantiationException::InstantiationException(const ::java::lang::String & a0) : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
  }
}
  ...
  namespace lang {
    ...
    jclass ClassLoader::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_clearAssertionStatus_3b7a1d3d26162b85] = env->getMethodID(cls, "clearAssertionStatus", "()V");
        mids$[mid_getParent_c3b4e13d45aa948d] = env->getMethodID(cls, "getParent", "()Ljava/lang/ClassLoader;");
        mids$[mid_getSystemClassLoader_c3b4e13d45aa948d] = env->getStaticMethodID(cls, "getSystemClassLoader", "()Ljava/lang/ClassLoader;");
        mids$[mid_loadClass_3db5ad13abace10f] = env->getMethodID(cls, "loadClass", "(Ljava/lang/String;)Ljava/lang/Class;");
        mids$[mid_setClassAssertionStatus_b5c0f2463d1354e7] = env->getMethodID(cls, "setClassAssertionStatus", "(Ljava/lang/String;Z)V");
        mids$[mid_setDefaultAssertionStatus_4e7a2bdefbe801b3] = env->getMethodID(cls, "setDefaultAssertionStatus", "(Z)V");
        mids$[mid_setPackageAssertionStatus_b5c0f2463d1354e7] = env->getMethodID(cls, "setPackageAssertionStatus", "(Ljava/lang/String;Z)V");
        mids$[mid_loadClass_a25db3df2ed5cbd5] = env->getMethodID(cls, "loadClass", "(Ljava/lang/String;Z)Ljava/lang/Class;");
        mids$[mid_getPackage_f8e67dcd7ece1694] = env->getMethodID(cls, "getPackage", "(Ljava/lang/String;)Ljava/lang/Package;");
        mids$[mid_setSigners_6d68747532a255d3] = env->getMethodID(cls, "setSigners", "(Ljava/lang/Class;[Ljava/lang/Object;)V");
        mids$[mid_getClassLoadingLock_ff07a348f6d890ba] = env->getMethodID(cls, "getClassLoadingLock", "(Ljava/lang/String;)Ljava/lang/Object;");
        mids$[mid_findClass_3db5ad13abace10f] = env->getMethodID(cls, "findClass", "(Ljava/lang/String;)Ljava/lang/Class;");
        mids$[mid_defineClass_41ca5a2a8a3676c0] = env->getMethodID(cls, "defineClass", "([BII)Ljava/lang/Class;");
        mids$[mid_defineClass_a54b9bae0a183ab1] = env->getMethodID(cls, "defineClass", "(Ljava/lang/String;[BIILjava/security/ProtectionDomain;)Ljava/lang/Class;");
        mids$[mid_defineClass_1c64ef94eeed56c4] = env->getMethodID(cls, "defineClass", "(Ljava/lang/String;[BII)Ljava/lang/Class;");
        mids$[mid_defineClass_af0f6e0f6dd5cd15] = env->getMethodID(cls, "defineClass", "(Ljava/lang/String;Ljava/nio/ByteBuffer;Ljava/security/ProtectionDomain;)Ljava/lang/Class;");
        mids$[mid_resolveClass_24b7cc29b8390607] = env->getMethodID(cls, "resolveClass", "(Ljava/lang/Class;)V");
        mids$[mid_findSystemClass_3db5ad13abace10f] = env->getMethodID(cls, "findSystemClass", "(Ljava/lang/String;)Ljava/lang/Class;");
        mids$[mid_findLoadedClass_3db5ad13abace10f] = env->getMethodID(cls, "findLoadedClass", "(Ljava/lang/String;)Ljava/lang/Class;");
        mids$[mid_findResource_6fa68873b72e5dd6] = env->getMethodID(cls, "findResource", "(Ljava/lang/String;)Ljava/net/URL;");
        mids$[mid_findResources_4bc0575416646ead] = env->getMethodID(cls, "findResources", "(Ljava/lang/String;)Ljava/util/Enumeration;");
        mids$[mid_registerAsParallelCapable_318f7cae9d6a33e6] = env->getStaticMethodID(cls, "registerAsParallelCapable", "()Z");
        mids$[mid_definePackage_8c1e479ffd51772e] = env->getMethodID(cls, "definePackage", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/URL;)Ljava/lang/Package;");
        mids$[mid_getPackages_e9607c4a35e971a3] = env->getMethodID(cls, "getPackages", "()[Ljava/lang/Package;");
        mids$[mid_findLibrary_c79c18cd95453b7f] = env->getMethodID(cls, "findLibrary", "(Ljava/lang/String;)Ljava/lang/String;");
    ...
    {
      env->callVoidMethod(this$, mids$[mid_clearAssertionStatus_3b7a1d3d26162b85]);
    }

    ClassLoader ClassLoader::getParent() const
    {
      return ClassLoader(env->callObjectMethod(this$, mids$[mid_getParent_c3b4e13d45aa948d]));
    }

    ClassLoader ClassLoader::getSystemClassLoader()
    {
      jclass cls = env->getClass(initializeClass);
      return ClassLoader(env->callStaticObjectMethod(cls, mids$[mid_getSystemClassLoader_c3b4e13d45aa948d]));
    }

    ::java::lang::Class ClassLoader::loadClass(const ::java::lang::String & a0) const
    {
      return ::java::lang::Class(env->callObjectMethod(this$, mids$[mid_loadClass_3db5ad13abace10f], a0.this$));
    }

    void ClassLoader::setClassAssertionStatus(const ::java::lang::String & a0, jboolean a1) const
    {
      env->callVoidMethod(this$, mids$[mid_setClassAssertionStatus_b5c0f2463d1354e7], a0.this$, a1);
    }

    void ClassLoader::setDefaultAssertionStatus(jboolean a0) const
    {
      env->callVoidMethod(this$, mids$[mid_setDefaultAssertionStatus_4e7a2bdefbe801b3], a0);
    }

    void ClassLoader::setPackageAssertionStatus(const ::java::lang::String & a0, jboolean a1) const
    {
      env->callVoidMethod(this$, mids$[mid_setPackageAssertionStatus_b5c0f2463d1354e7], a0.this$, a1);
    }
  }
}
  ...
  namespace lang {
    ...
    jclass Package::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_getImplementationTitle_c041e21e63165d2d] = env->getMethodID(cls, "getImplementationTitle", "()Ljava/lang/String;");
        mids$[mid_getImplementationVendor_c041e21e63165d2d] = env->getMethodID(cls, "getImplementationVendor", "()Ljava/lang/String;");
        mids$[mid_getImplementationVersion_c041e21e63165d2d] = env->getMethodID(cls, "getImplementationVersion", "()Ljava/lang/String;");
        mids$[mid_getName_c041e21e63165d2d] = env->getMethodID(cls, "getName", "()Ljava/lang/String;");
        mids$[mid_getPackage_f8e67dcd7ece1694] = env->getStaticMethodID(cls, "getPackage", "(Ljava/lang/String;)Ljava/lang/Package;");
        mids$[mid_getPackages_e9607c4a35e971a3] = env->getStaticMethodID(cls, "getPackages", "()[Ljava/lang/Package;");
        mids$[mid_getSpecificationTitle_c041e21e63165d2d] = env->getMethodID(cls, "getSpecificationTitle", "()Ljava/lang/String;");
        mids$[mid_getSpecificationVendor_c041e21e63165d2d] = env->getMethodID(cls, "getSpecificationVendor", "()Ljava/lang/String;");
        mids$[mid_getSpecificationVersion_c041e21e63165d2d] = env->getMethodID(cls, "getSpecificationVersion", "()Ljava/lang/String;");
        mids$[mid_hashCode_60df5a771df5b62d] = env->getMethodID(cls, "hashCode", "()I");
        mids$[mid_isCompatibleWith_1dfa664233a47103] = env->getMethodID(cls, "isCompatibleWith", "(Ljava/lang/String;)Z");
        mids$[mid_isSealed_318f7cae9d6a33e6] = env->getMethodID(cls, "isSealed", "()Z");
        mids$[mid_toString_c041e21e63165d2d] = env->getMethodID(cls, "toString", "()Ljava/lang/String;");
    ...
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getImplementationTitle_c041e21e63165d2d]));
    }

    ::java::lang::String Package::getImplementationVendor() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getImplementationVendor_c041e21e63165d2d]));
    }

    ::java::lang::String Package::getImplementationVersion() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getImplementationVersion_c041e21e63165d2d]));
    }
    ...
    {
      jclass cls = env->getClass(initializeClass);
      return Package(env->callStaticObjectMethod(cls, mids$[mid_getPackage_f8e67dcd7ece1694], a0.this$));
    }

    JArray< Package > Package::getPackages()
    {
      jclass cls = env->getClass(initializeClass);
      return JArray< Package >(env->callStaticObjectMethod(cls, mids$[mid_getPackages_e9607c4a35e971a3]));
    }

    ::java::lang::String Package::getSpecificationTitle() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getSpecificationTitle_c041e21e63165d2d]));
    }

    ::java::lang::String Package::getSpecificationVendor() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getSpecificationVendor_c041e21e63165d2d]));
    }

    ::java::lang::String Package::getSpecificationVersion() const
    {
      return ::java::lang::String(env->callObjectMethod(this$, mids$[mid_getSpecificationVersion_c041e21e63165d2d]));
    }
    ...
    {
      return env->callBooleanMethod(this$, mids$[mid_isCompatibleWith_1dfa664233a47103], a0.this$);
    }

    jboolean Package::isSealed() const
    {
      return env->callBooleanMethod(this$, mids$[mid_isSealed_318f7cae9d6a33e6]);
    }
...
namespace java {
  namespace lang {
    ...
    SecurityException::SecurityException() : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    SecurityException::SecurityException(const ::java::lang::Throwable & a0) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_359aa6a1d41f0219, a0.this$)) {}

    SecurityException::SecurityException(const ::java::lang::String & a0) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}

    SecurityException::SecurityException(const ::java::lang::String & a0, const ::java::lang::Throwable & a1) : ::java::lang::RuntimeException(env->newObject(initializeClass, &mids$, mid_init$_5df017320dfbf543, a0.this$, a1.this$)) {}
  }
}
...
namespace java {
  namespace lang {
    ...
    IllegalAccessException::IllegalAccessException() : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_3b7a1d3d26162b85)) {}

    IllegalAccessException::IllegalAccessException(const ::java::lang::String & a0) : ::java::lang::ReflectiveOperationException(env->newObject(initializeClass, &mids$, mid_init$_38d57a80b9fe8948, a0.this$)) {}
  }
}
...
namespace java {
  namespace lang {
    ...
    {
      return CharSequence(env->callObjectMethod(this$, mids$[mid_subSequence_4648df63ce82f704], a0, a1));
    }
  ...
  namespace lang {
    ...
    jclass Appendable::initializeClass(bool getOnly)
    {
      ...
      if (class$ == NULL)
      {
        ...
        mids$ = new jmethodID[max_mid];
        mids$[mid_append_3108d4be035ceaa2] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;)Ljava/lang/Appendable;");
        mids$[mid_append_e2ee5ed460890580] = env->getMethodID(cls, "append", "(C)Ljava/lang/Appendable;");
        mids$[mid_append_be35c96e4bf84f5f] = env->getMethodID(cls, "append", "(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;");
    ...
    {
      return Appendable(env->callObjectMethod(this$, mids$[mid_append_3108d4be035ceaa2], a0.this$));
    }

    Appendable Appendable::append(jchar a0) const
    {
      return Appendable(env->callObjectMethod(this$, mids$[mid_append_e2ee5ed460890580], a0));
    }

    Appendable Appendable::append(const ::java::lang::CharSequence & a0, jint a1, jint a2) const
    {
      return Appendable(env->callObjectMethod(this$, mids$[mid_append_be35c96e4bf84f5f], a0.this$, a1, a2));
    }
  }
}
